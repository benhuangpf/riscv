...
void VTop___024root__trace_chg_sub_0(VTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+36,(((IData)(vlSelf->Top__DOT__decoder_io_bundleCtrl_ctrlStore) 
                               & (~ (IData)(vlSelf->Top__DOT__decoder_io_bundleCtrl_ctrlALUSrc)))));
        bufp->chgSData(oldp+37,((0xfffU & (vlSelf->Top__DOT__pcReg__DOT__regPC 
                                           >> 2U))),12);
    ...
    bufp->chgIData(oldp+72,(vlSelf->io_ans),32);
    bufp->chgIData(oldp+73,(vlSelf->io_addr),32);
    bufp->chgIData(oldp+74,(vlSelf->io_inst),32);
    bufp->chgBit(oldp+75,(vlSelf->io_bundleCtrl_ctrlJump));
    bufp->chgBit(oldp+76,(vlSelf->io_bundleCtrl_ctrlBranch));
    bufp->chgBit(oldp+77,(vlSelf->io_bundleCtrl_ctrlRegWrite));
    bufp->chgBit(oldp+78,(vlSelf->io_bundleCtrl_ctrlLoad));
    bufp->chgBit(oldp+79,(vlSelf->io_bundleCtrl_ctrlStore));
    bufp->chgBit(oldp+80,(vlSelf->io_bundleCtrl_ctrlALUSrc));
    bufp->chgBit(oldp+81,(vlSelf->io_bundleCtrl_ctrlJAL));
    bufp->chgCData(oldp+82,(vlSelf->io_bundleCtrl_ctrlOP),4);
    bufp->chgBit(oldp+83,(vlSelf->io_bundleCtrl_ctrlSigned));
    bufp->chgCData(oldp+84,(vlSelf->io_bundleCtrl_ctrlLSType),2);
    bufp->chgIData(oldp+85,(vlSelf->io_resultALU),32);
    bufp->chgIData(oldp+86,(vlSelf->io_rs1),32);
    bufp->chgIData(oldp+87,(vlSelf->io_rs2),32);
    bufp->chgIData(oldp+88,(vlSelf->io_imm),32);
    bufp->chgBit(oldp+89,(vlSelf->io_resultBranch));
    bufp->chgIData(oldp+90,(vlSelf->io_result),32);
}
