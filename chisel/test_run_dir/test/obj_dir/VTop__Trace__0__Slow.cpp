...
VL_ATTR_COLD void VTop___024root__trace_init_sub__TOP__0(VTop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+73,"io_addr", false,-1, 31,0);
    tracep->declBus(c+74,"io_inst", false,-1, 31,0);
    tracep->declBit(c+75,"io_bundleCtrl_ctrlJump", false,-1);
    tracep->declBit(c+76,"io_bundleCtrl_ctrlBranch", false,-1);
    tracep->declBit(c+77,"io_bundleCtrl_ctrlRegWrite", false,-1);
    tracep->declBit(c+78,"io_bundleCtrl_ctrlLoad", false,-1);
    tracep->declBit(c+79,"io_bundleCtrl_ctrlStore", false,-1);
    tracep->declBit(c+80,"io_bundleCtrl_ctrlALUSrc", false,-1);
    tracep->declBit(c+81,"io_bundleCtrl_ctrlJAL", false,-1);
    tracep->declBus(c+82,"io_bundleCtrl_ctrlOP", false,-1, 3,0);
    tracep->declBit(c+83,"io_bundleCtrl_ctrlSigned", false,-1);
    tracep->declBus(c+84,"io_bundleCtrl_ctrlLSType", false,-1, 1,0);
    tracep->declBus(c+85,"io_resultALU", false,-1, 31,0);
    tracep->declBus(c+86,"io_rs1", false,-1, 31,0);
    tracep->declBus(c+87,"io_rs2", false,-1, 31,0);
    tracep->declBus(c+88,"io_imm", false,-1, 31,0);
    tracep->declBit(c+89,"io_resultBranch", false,-1);
    tracep->declBus(c+90,"io_result", false,-1, 31,0);
    ...
    tracep->declBit(c+91,"mem_dataLoad_MPORT_en", false,-1);
    ...
    tracep->declBit(c+91,"mem_MPORT_mask", false,-1);
    tracep->declBit(c+92,"mem_MPORT_en", false,-1);
    tracep->declBus(c+34,"mem_MPORT_1_data", false,-1, 31,0);
    tracep->declBus(c+32,"mem_MPORT_1_addr", false,-1, 9,0);
    tracep->declBit(c+91,"mem_MPORT_1_mask", false,-1);
    ...
    tracep->declBit(c+91,"mem_MPORT_2_mask", false,-1);
    ...
    tracep->declBus(c+6,"io_inst", false,-1, 31,0);
    tracep->declBit(c+91,"mem_io_inst_MPORT_en", false,-1);
    tracep->declBus(c+38,"mem_io_inst_MPORT_addr", false,-1, 9,0);
...
VL_ATTR_COLD void VTop___024root__trace_full_sub_0(VTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+37,(((IData)(vlSelf->Top__DOT__decoder_io_bundleCtrl_ctrlStore) 
                            & (~ (IData)(vlSelf->Top__DOT__decoder_io_bundleCtrl_ctrlALUSrc)))));
    bufp->fullSData(oldp+38,((0x3ffU & (vlSelf->Top__DOT__pcReg__DOT__regPC 
                                        >> 2U))),10);
    ...
    bufp->fullIData(oldp+73,(vlSelf->io_addr),32);
    bufp->fullIData(oldp+74,(vlSelf->io_inst),32);
    bufp->fullBit(oldp+75,(vlSelf->io_bundleCtrl_ctrlJump));
    bufp->fullBit(oldp+76,(vlSelf->io_bundleCtrl_ctrlBranch));
    bufp->fullBit(oldp+77,(vlSelf->io_bundleCtrl_ctrlRegWrite));
    bufp->fullBit(oldp+78,(vlSelf->io_bundleCtrl_ctrlLoad));
    bufp->fullBit(oldp+79,(vlSelf->io_bundleCtrl_ctrlStore));
    bufp->fullBit(oldp+80,(vlSelf->io_bundleCtrl_ctrlALUSrc));
    bufp->fullBit(oldp+81,(vlSelf->io_bundleCtrl_ctrlJAL));
    bufp->fullCData(oldp+82,(vlSelf->io_bundleCtrl_ctrlOP),4);
    bufp->fullBit(oldp+83,(vlSelf->io_bundleCtrl_ctrlSigned));
    bufp->fullCData(oldp+84,(vlSelf->io_bundleCtrl_ctrlLSType),2);
    bufp->fullIData(oldp+85,(vlSelf->io_resultALU),32);
    bufp->fullIData(oldp+86,(vlSelf->io_rs1),32);
    bufp->fullIData(oldp+87,(vlSelf->io_rs2),32);
    bufp->fullIData(oldp+88,(vlSelf->io_imm),32);
    bufp->fullBit(oldp+89,(vlSelf->io_resultBranch));
    bufp->fullIData(oldp+90,(vlSelf->io_result),32);
