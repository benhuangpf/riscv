...
module regfile_combMem(	// @[dpath.scala:120:21]
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [4:0]  R1_addr,
  ...
  always @(posedge W0_clk) begin	// @[dpath.scala:120:21]
    if (W0_en)	// @[dpath.scala:120:21]
      Memory[W0_addr] <= W0_data;	// @[dpath.scala:120:21]
  end // always @(posedge)
  `ifndef SYNTHESIS	// @[dpath.scala:120:21]
    `ifdef RANDOMIZE_MEM_INIT	// @[dpath.scala:120:21]
      integer initvar;	// @[dpath.scala:120:21]
      reg [31:0] _RANDOM_MEM;	// @[dpath.scala:120:21]
    `endif // RANDOMIZE_MEM_INIT
    initial begin	// @[dpath.scala:120:21]
      `INIT_RANDOM_PROLOG_	// @[dpath.scala:120:21]
      `ifdef RANDOMIZE_MEM_INIT	// @[dpath.scala:120:21]
        for (initvar = 0; initvar < 32; initvar = initvar + 1) begin
          _RANDOM_MEM = {`RANDOM};
          Memory[initvar] = _RANDOM_MEM[31:0];
        end	// @[dpath.scala:120:21]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
