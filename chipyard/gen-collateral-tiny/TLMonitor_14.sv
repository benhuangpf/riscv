...
module TLMonitor_14(
  ...
  wire         _T_1214 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1145 = _T_1214 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire         _T_1160 = _T_1282 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1214) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1214 | _T_1282)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Bundles.scala:259:74, Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1214 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_26 = _T_1164 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_27 = _T_1164 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_28 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire             _T_1243 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [32:0]     _T_1146 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [32:0]     _T_1165 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [263:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :638:40]
    wire  [32:0]     _T_1244 = 33'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(_T_379 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | io_in_a_bits_address[31:16] == 16'h1 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Monitor.scala:42:11, :104:45, :723:35, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_476 & (~(|(io_in_a_bits_source[5:4])) | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (_T_476 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, :723:35, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(_T_572 & (~(|(io_in_a_bits_source[5:4])) | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (_T_572 & io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_size < 4'h7 & (_GEN_8 == 19'h0 | _GEN_9 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:14] == 18'h20000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :723:35, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (io_in_a_bits_size < 4'h3 & (io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_address[31:12] == 20'h4 | io_in_a_bits_address[31:12] == 20'h54000) | io_in_a_bits_size == 4'h2 & io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :91:48, :92:42, :137:{31,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _source_ok_WIRE_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & (io_in_a_bits_size < 4'h3 & (io_in_a_bits_address[31:12] == 20'h3 | io_in_a_bits_address[31:12] == 20'h4 | io_in_a_bits_address[31:12] == 20'h54000) | io_in_a_bits_size == 4'h2 & io_in_a_bits_address[31:14] == 18'h20000))) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :91:48, :92:42, :137:{31,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1243 & ~reset & ~(_T_1244[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1243 & ~reset & _GEN_28 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
