  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM_0[15:10];	// @[Repeater.scala:19:21, :20:18]
        saved_address = _RANDOM_0[30:16];	// @[Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM_0[31], _RANDOM_1[2:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_2[3];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
