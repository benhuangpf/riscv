...
module TLXbar_6(
  ...
  wire        out_7_valid = auto_out_d_valid & auto_out_d_bits_source;	// @[Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & ~auto_out_d_bits_source;	// @[Parameters.scala:46:9, Xbar.scala:182:40]
  reg  [9:0]  beatsLeft;	// @[Arbiter.scala:88:30]
  wire        idle = beatsLeft == 10'h0;	// @[Arbiter.scala:88:30, :89:28, :112:73, Edges.scala:221:14]
  ...
  wire        x1_out_1_bits_source = idle ? earlyWinner_0 : state_0;	// @[Arbiter.scala:89:28, :98:79, :117:26, :118:30]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 10'h0;	// @[Arbiter.scala:88:30, :112:73, Edges.scala:221:14]
      ...
      if (latch) begin	// @[Arbiter.scala:90:24]
        if (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]))	// @[Arbiter.scala:99:79, :112:73, Edges.scala:92:{28,37}, :221:14]
          beatsLeft <= ~(_beatsAI_decode_T_1[11:2]);	// @[Arbiter.scala:88:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:112:73, Edges.scala:221:14]
          beatsLeft <= 10'h0;	// @[Arbiter.scala:88:30, :112:73, Edges.scala:221:14]
      end
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {9'h0, auto_out_a_ready & x1_out_1_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  TLMonitor_30 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_out_a_bits_opcode = (x1_out_1_bits_source ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:26:66, :118:30, Mux.scala:27:73]
  assign auto_out_a_bits_param = x1_out_1_bits_source ? auto_in_0_a_bits_param : 3'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_size = (x1_out_1_bits_source ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? 4'h6 : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = x1_out_1_bits_source;	// @[Arbiter.scala:118:30]
  assign auto_out_a_bits_address = (x1_out_1_bits_source ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (x1_out_1_bits_source ? auto_in_0_a_bits_mask : 4'h0) | {4{muxStateEarly_1}};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = x1_out_1_bits_source ? auto_in_0_a_bits_data : 32'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_d_ready = auto_out_d_bits_source & auto_in_0_d_ready | ~auto_out_d_bits_source;	// @[Mux.scala:27:73, Parameters.scala:46:9]
endmodule
