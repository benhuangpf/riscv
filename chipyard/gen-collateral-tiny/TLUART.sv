...
module TLUART(
  ...
  wire             _out_out_bits_data_WIRE_6 = auto_control_xing_in_a_bits_address[11:5] == 7'h0;	// @[Edges.scala:192:34, OneHot.scala:57:35, RegisterRouter.scala:73:19, :83:24]
  ...
  assign out_backSel_1 = auto_control_xing_in_a_bits_address[4:2] == 3'h1;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  ...
  assign out_woready_2 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h0 & _out_out_bits_data_WIRE_6;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire             out_woready_11 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h2 & _out_out_bits_data_WIRE_6;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire             out_woready_13 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h3 & _out_out_bits_data_WIRE_6;	// @[Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  wire             out_woready_15 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h4 & _out_out_bits_data_WIRE_6;	// @[Cat.scala:33:92, RegisterRouter.scala:72:36, :83:24]
  wire [7:0]       _GEN = {{1'h1}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}};	// @[Buffer.scala:47:20, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
  wire [7:0][31:0] _GEN_0 = {{32'h0}, {{16'h0, div}}, {{30'h0, ip_rxwm, ip_txwm}}, {{30'h0, ie_rxwm, ie_txwm}}, {{7'h0, rxwm, 15'h0, rxen}}, {{7'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits}}, {{~_txq_io_enq_ready, 31'h0}}};	// @[Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, OneHot.scala:57:35, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:83:24, UART.scala:131:19, :134:19, :136:20, :142:21, :143:21, :150:21, :151:21, :152:22, :186:19, :189:28, :190:28]
  wire [2:0]       x1_3_d_bits_opcode = {2'h0, out_front_bits_read};	// @[RegisterRouter.scala:72:36, :98:19]
  wire [8:0]       _out_womask_T_13 = {auto_control_xing_in_a_bits_mask[3], {8{auto_control_xing_in_a_bits_mask[2]}}};	// @[Bitwise.scala:28:17, :77:12, RegisterRouter.scala:83:24]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h6 & _out_out_bits_data_WIRE_6 & (&{{8{auto_control_xing_in_a_bits_mask[1]}}, {8{auto_control_xing_in_a_bits_mask[0]}}}))	// @[Bitwise.scala:28:17, :77:12, Cat.scala:33:92, OneHot.scala:57:35, RegisterRouter.scala:83:24]
        div <= auto_control_xing_in_a_bits_data[15:0];	// @[RegisterRouter.scala:83:24, UART.scala:136:20]
      if (out_woready_11 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        txen <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:83:24, UART.scala:142:21]
      if (out_woready_13 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        rxen <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:83:24, UART.scala:143:21]
      if (out_woready_11 & (&_out_womask_T_13))	// @[RegisterRouter.scala:83:24]
        txwm <= auto_control_xing_in_a_bits_data[24:16];	// @[RegisterRouter.scala:83:24, UART.scala:150:21]
      if (out_woready_13 & (&_out_womask_T_13))	// @[RegisterRouter.scala:83:24]
        rxwm <= auto_control_xing_in_a_bits_data[24:16];	// @[RegisterRouter.scala:83:24, UART.scala:151:21]
      if (out_woready_11 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
        nstop <= auto_control_xing_in_a_bits_data[1];	// @[RegisterRouter.scala:83:24, UART.scala:152:22]
      if (out_woready_15 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:83:24]
  ...
  Queue_20 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_20 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
    .io_enq_valid (_rxm_io_out_valid),	// @[UART.scala:133:19]
    .io_enq_bits  (_rxm_io_out_bits),	// @[UART.scala:133:19]
    .io_deq_ready (_out_wofireMux_T & out_front_bits_read & out_backSel_1 & _out_out_bits_data_WIRE_6 & auto_control_xing_in_a_bits_mask[0]),	// @[Bitwise.scala:28:17, RegisterRouter.scala:72:36, :83:24]
  ...
  assign auto_control_xing_in_d_bits_data = _GEN[auto_control_xing_in_a_bits_address[4:2]] ? _GEN_0[auto_control_xing_in_a_bits_address[4:2]] : 32'h0;	// @[Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
endmodule
