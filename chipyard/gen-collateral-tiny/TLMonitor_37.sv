  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_4 = `RANDOM;
        _RANDOM_5 = `RANDOM;
        inflight = _RANDOM_4[21];	// @[Monitor.scala:611:27]
        inflight_opcodes = _RANDOM_4[25:22];	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = _RANDOM_4[29:26];	// @[Monitor.scala:611:27, :615:33]
        watchdog = _RANDOM_5;	// @[Monitor.scala:706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
