...
module PeripheryBus_1(
  ...
  input  [5:0]  auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_source,
  ...
  output [5:0]  auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_source,
  ...
  TLXbar_5 out_xbar (	// @[PeripheryBus.scala:50:30]
    ...
    .auto_out_4_a_ready        (auto_coupler_to_tile_tl_slave_clock_xing_out_a_ready),
    .auto_out_4_d_valid        (auto_coupler_to_tile_tl_slave_clock_xing_out_d_valid),
    .auto_out_4_d_bits_opcode  (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_opcode),
    .auto_out_4_d_bits_param   (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_param),
    .auto_out_4_d_bits_size    (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_size),
    .auto_out_4_d_bits_source  (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_source),
    .auto_out_4_d_bits_sink    (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_sink),
    .auto_out_4_d_bits_denied  (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_denied),
    .auto_out_4_d_bits_data    (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_data),
    .auto_out_4_d_bits_corrupt (auto_coupler_to_tile_tl_slave_clock_xing_out_d_bits_corrupt),
    ...
    .auto_out_4_a_valid        (auto_coupler_to_tile_tl_slave_clock_xing_out_a_valid),
    .auto_out_4_a_bits_opcode  (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_opcode),
    .auto_out_4_a_bits_param   (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_param),
    .auto_out_4_a_bits_size    (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_size),
    .auto_out_4_a_bits_source  (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_source),
    .auto_out_4_a_bits_address (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_address),
    .auto_out_4_a_bits_mask    (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_mask),
    .auto_out_4_a_bits_data    (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_data),
    .auto_out_4_a_bits_corrupt (auto_coupler_to_tile_tl_slave_clock_xing_out_a_bits_corrupt),
    .auto_out_4_d_ready        (auto_coupler_to_tile_tl_slave_clock_xing_out_d_ready),
