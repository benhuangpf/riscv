...
module Queue_11(
  ...
  wire [66:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[15:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_address = _ram_ext_R0_data[29:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[33:30];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[65:34];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[66];	// @[Decoupled.scala:273:95]
endmodule
