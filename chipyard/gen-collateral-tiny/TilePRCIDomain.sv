...
module TilePRCIDomain(
  ...
  wire        _tile_reset_domain_tile_auto_buffer_in_a_ready;	// @[HasTiles.scala:251:53]
  wire        _tile_reset_domain_tile_auto_buffer_in_d_valid;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_in_d_bits_opcode;	// @[HasTiles.scala:251:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_in_d_bits_size;	// @[HasTiles.scala:251:53]
  wire [5:0]  _tile_reset_domain_tile_auto_buffer_in_d_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_tile_auto_buffer_in_d_bits_data;	// @[HasTiles.scala:251:53]
  ...
  wire        _tile_reset_domain_tile_auto_buffer_out_a_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_tile_auto_buffer_out_a_bits_address;	// @[HasTiles.scala:251:53]
  wire [3:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_mask;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_tile_auto_buffer_out_a_bits_data;	// @[HasTiles.scala:251:53]
  ...
  RocketTile tile_reset_domain_tile (	// @[HasTiles.scala:251:53]
    ...
    .auto_buffer_in_a_ready         (_tile_reset_domain_tile_auto_buffer_in_a_ready),
    .auto_buffer_in_d_valid         (_tile_reset_domain_tile_auto_buffer_in_d_valid),
    .auto_buffer_in_d_bits_opcode   (_tile_reset_domain_tile_auto_buffer_in_d_bits_opcode),
    .auto_buffer_in_d_bits_size     (_tile_reset_domain_tile_auto_buffer_in_d_bits_size),
    .auto_buffer_in_d_bits_source   (_tile_reset_domain_tile_auto_buffer_in_d_bits_source),
    .auto_buffer_in_d_bits_data     (_tile_reset_domain_tile_auto_buffer_in_d_bits_data),
  ...
  TLBuffer_11 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
  ...
  TLBuffer_12 buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    ...
    .auto_out_a_ready        (_tile_reset_domain_tile_auto_buffer_in_a_ready),	// @[HasTiles.scala:251:53]
    .auto_out_d_valid        (_tile_reset_domain_tile_auto_buffer_in_d_valid),	// @[HasTiles.scala:251:53]
    .auto_out_d_bits_opcode  (_tile_reset_domain_tile_auto_buffer_in_d_bits_opcode),	// @[HasTiles.scala:251:53]
    .auto_out_d_bits_size    (_tile_reset_domain_tile_auto_buffer_in_d_bits_size),	// @[HasTiles.scala:251:53]
    .auto_out_d_bits_source  (_tile_reset_domain_tile_auto_buffer_in_d_bits_source),	// @[HasTiles.scala:251:53]
    .auto_out_d_bits_data    (_tile_reset_domain_tile_auto_buffer_in_d_bits_data),	// @[HasTiles.scala:251:53]
