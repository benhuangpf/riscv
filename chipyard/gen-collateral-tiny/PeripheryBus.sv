...
module PeripheryBus(
  ...
  wire [5:0]  _coupler_to_device_named_uart_0_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [31:0] _coupler_to_device_named_uart_0_auto_tl_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire [3:0]  _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask;	// @[LazyModule.scala:489:27]
  wire [31:0] _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire [31:0] _coupler_to_bootaddressreg_auto_tl_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  reg  [31:0] bootAddrReg;	// @[BootAddrReg.scala:32:34]
  ...
  wire        _out_out_bits_data_T_1 = _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_address[11:2] == 10'h0;	// @[Edges.scala:192:34, LazyModule.scala:489:27, RegisterRouter.scala:73:19, :83:24]
  wire        valids_0 = out_woready_3 & _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask[0];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:83:24]
  wire        valids_1 = out_woready_3 & _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask[1];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:83:24]
  wire        valids_2 = out_woready_3 & _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask[2];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:83:24]
  wire        valids_3 = out_woready_3 & _coupler_to_bootaddressreg_auto_fragmenter_out_a_bits_mask[3];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:83:24]
  assign out_woready_3 = _coupler_to_bootaddressreg_auto_fragmenter_out_a_valid & _coupler_to_bootaddressreg_auto_fragmenter_out_d_ready & ~out_front_bits_read & _out_out_bits_data_T_1;	// @[LazyModule.scala:489:27, RegisterRouter.scala:72:36, :83:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        bootAddrReg = _RANDOM_0;	// @[BootAddrReg.scala:32:34]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLBuffer_2 buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_4 coupler_to_bootaddressreg (	// @[LazyModule.scala:489:27]
    ...
    .auto_fragmenter_out_d_bits_data    (_out_out_bits_data_T_1 ? bootAddrReg : 32'h0),	// @[BootAddrReg.scala:32:34, Bundles.scala:259:74, RegisterRouter.scala:83:24]
