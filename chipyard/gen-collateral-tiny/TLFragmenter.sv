...
module TLFragmenter(
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {9'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
