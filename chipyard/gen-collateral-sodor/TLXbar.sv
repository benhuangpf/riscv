...
module TLXbar(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[4:1] == 4'h8;	// @[Parameters.scala:54:{10,32}]
  wire        out_7_valid = auto_out_d_valid & ~(auto_out_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & requestDOI_0_1;	// @[Parameters.scala:54:32, Xbar.scala:182:40]
  ...
  TLMonitor monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[3:0]),	// @[Xbar.scala:231:69]
  ...
  assign auto_in_1_d_bits_source = auto_out_d_bits_source[0];	// @[Xbar.scala:231:69]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 5'h0) | (muxStateEarly_1 ? {4'h8, auto_in_1_a_bits_source} : 5'h0);	// @[Arbiter.scala:118:30, Bundle_ACancel.scala:56:22, Mux.scala:27:73, Parameters.scala:54:32, Xbar.scala:240:{29,55}, :265:23]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 4'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_d_ready = ~(auto_out_d_bits_source[4]) & auto_in_0_d_ready | requestDOI_0_1 & auto_in_1_d_ready;	// @[Mux.scala:27:73, Parameters.scala:54:{10,32}]
endmodule
