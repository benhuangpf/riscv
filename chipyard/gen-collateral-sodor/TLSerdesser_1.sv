...
module TLSerdesser_1(
  ...
  TLMonitor_48 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[1]),	// @[Serdes.scala:463:17, :645:23]
  ...
  HellaPeekingArbiter_TestHarness_UNIQUIFIED outArb (	// @[Serdes.scala:638:24]
    ...
    .io_in_4_bits_data    ({32'h0, auto_manager_in_a_bits_data}),	// @[Serdes.scala:258:20, :259:20]
    .io_in_4_bits_corrupt (auto_manager_in_a_bits_corrupt),
    .io_in_4_bits_union   ({5'h0, auto_manager_in_a_bits_mask}),	// @[Serdes.scala:262:20]
  ...
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[1];	// @[Serdes.scala:463:17, :645:23]
  assign auto_manager_in_d_bits_denied = _inDes_io_out_bits_union[0];	// @[Serdes.scala:464:30, :645:23]
  assign auto_manager_in_d_bits_data = _inDes_io_out_bits_data[31:0];	// @[Serdes.scala:404:15, :645:23]
