...
module Queue_13(
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[35:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[39:36];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[71:40];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[72];	// @[Decoupled.scala:273:95]
endmodule
