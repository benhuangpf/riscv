...
module TLMonitor_45(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [7:0]      _GEN_8 = {io_in_a_bits_address[20:17] ^ 4'h8, io_in_a_bits_address[15:12]};	// @[Parameters.scala:137:{31,45}]
    ...
    wire  [4223:0]   _GEN_19 = {4211'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:122:25, :634:44]
    ...
    wire  [3:0]      _GEN_23 = {2'h0, io_in_d_bits_size};	// @[Monitor.scala:122:25, :691:36]
    ...
    wire  [1055:0]   _T_697 = 1056'h0 >> _GEN_20;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [4223:0]   _c_size_lookup_T_1 = 4224'h0 >> _GEN_19;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & ~(io_in_a_bits_size != 2'h3 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{45,65}, :671:54, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_7 & ~reset & _GEN_9) begin	// @[Monitor.scala:42:11, :104:45, :110:30]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 11'h420 & io_in_a_bits_size != 2'h3 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{45,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & _GEN_4) begin	// @[Monitor.scala:42:11, :114:53, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 11'h420 & io_in_a_bits_size != 2'h3 & _GEN_8 == 8'h0)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{45,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & _GEN_4) begin	// @[Monitor.scala:42:11, :122:56, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & _GEN_4) begin	// @[Monitor.scala:42:11, :130:56, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & _GEN_4) begin	// @[Monitor.scala:42:11, :138:53, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & _GEN_4) begin	// @[Monitor.scala:42:11, :146:46, Parameters.scala:57:20]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
