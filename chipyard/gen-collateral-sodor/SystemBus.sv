...
module SystemBus(
  input         auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_valid,
  input  [2:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_opcode,
                auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_param,
  input  [3:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_size,
  input         auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_source,
  input  [31:0] auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_address,
  input  [3:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_mask,
  input  [31:0] auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_data,
  input         auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_corrupt,
                auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_ready,
  ...
  output        auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_ready,
                auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_valid,
  output [2:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_opcode,
  output [1:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_param,
  output [3:0]  auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_size,
  output        auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_source,
                auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_sink,
                auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_denied,
  output [31:0] auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_data,
  output        auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_corrupt,
  ...
  wire        _fixer_auto_out_1_a_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  wire        _system_bus_xbar_auto_in_1_d_bits_source;	// @[SystemBus.scala:40:43]
  wire        _system_bus_xbar_auto_in_1_d_bits_sink;	// @[SystemBus.scala:40:43]
  ...
  wire        _system_bus_xbar_auto_in_0_d_bits_sink;	// @[SystemBus.scala:40:43]
  ...
  TLXbar system_bus_xbar (	// @[SystemBus.scala:40:43]
    ...
    .auto_out_a_ready         (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_ready),
    .auto_out_d_valid         (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_valid),
    .auto_out_d_bits_opcode   (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_opcode),
    .auto_out_d_bits_param    (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_param),
    .auto_out_d_bits_size     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_size),
    .auto_out_d_bits_source   (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_source),
    .auto_out_d_bits_sink     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_sink),
    .auto_out_d_bits_denied   (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_denied),
    .auto_out_d_bits_data     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_data),
    .auto_out_d_bits_corrupt  (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_corrupt),
    ...
    .auto_out_a_valid         (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_valid),
    .auto_out_a_bits_opcode   (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_opcode),
    .auto_out_a_bits_param    (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_param),
    .auto_out_a_bits_size     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_size),
    .auto_out_a_bits_source   (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_source),
    .auto_out_a_bits_address  (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_address),
    .auto_out_a_bits_mask     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_mask),
    .auto_out_a_bits_data     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_data),
    .auto_out_a_bits_corrupt  (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_corrupt),
    .auto_out_d_ready         (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_ready)
  );
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:146:27]
    .clock                     (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                     (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_in_1_a_valid         (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_valid),
    .auto_in_1_a_bits_opcode   (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_opcode),
    .auto_in_1_a_bits_param    (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_param),
    .auto_in_1_a_bits_size     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_size),
    .auto_in_1_a_bits_source   (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_source),
    .auto_in_1_a_bits_address  (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_address),
    .auto_in_1_a_bits_mask     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_mask),
    .auto_in_1_a_bits_data     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_data),
    .auto_in_1_a_bits_corrupt  (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_bits_corrupt),
    .auto_in_1_d_ready         (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_ready),
    ...
    .auto_in_1_a_ready         (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_a_ready),
    .auto_in_1_d_valid         (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_valid),
    .auto_in_1_d_bits_opcode   (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_opcode),
    .auto_in_1_d_bits_param    (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_param),
    .auto_in_1_d_bits_size     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_size),
    .auto_in_1_d_bits_source   (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_source),
    .auto_in_1_d_bits_sink     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_sink),
    .auto_in_1_d_bits_denied   (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_denied),
    .auto_in_1_d_bits_data     (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_data),
    .auto_in_1_d_bits_corrupt  (auto_coupler_from_sodor_tile_tl_master_clock_xing_in_d_bits_corrupt),
