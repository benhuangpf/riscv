...
module ScratchpadSlavePort(
  ...
  reg  [11:0]     acq_source;	// @[ScratchpadSlavePort.scala:55:18]
  ...
  wire            tl_in_a_ready = _ready_T | _bundleIn_0_d_bits_data_T & io_dmem_resp_valid & auto_in_d_ready;	// @[ScratchpadSlavePort.scala:104:{35,78}, package.scala:16:47]
  ...
  wire [31:0]     io_dmem_req_bits_req_addr = _io_dmem_req_bits_T ? acq_address : auto_in_a_bits_address;	// @[ScratchpadSlavePort.scala:55:18, :105:57, :110:41]
  wire            _io_dmem_req_bits_T_3 = _io_dmem_req_bits_T_1_opcode == 3'h1;	// @[Mux.scala:81:61, ScratchpadSlavePort.scala:48:17, :110:41]
  wire [1:0]      _io_dmem_req_bits_mask_full_desired_mask_T = {io_dmem_req_bits_req_addr[0] | (|io_dmem_req_bits_req_size), ~(io_dmem_req_bits_req_addr[0])};	// @[AMOALU.scala:18:{27,42,53}, :19:22, Cat.scala:33:92, ScratchpadSlavePort.scala:110:41]
  ...
  always @(posedge clock) begin
    ...
    else if (auto_in_a_valid & tl_in_a_ready | _io_dmem_req_bits_T)	// @[ScratchpadSlavePort.scala:104:35, :105:{38,48,57}]
    ...
    if (tl_in_a_ready & auto_in_a_valid) begin	// @[Decoupled.scala:51:35, ScratchpadSlavePort.scala:104:35]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        acq_source = _RANDOM_0[22:11];	// @[ScratchpadSlavePort.scala:46:24, :55:18]
        acq_address = {_RANDOM_0[31:23], _RANDOM_1[22:0]};	// @[ScratchpadSlavePort.scala:46:24, :55:18]
        acq_mask = _RANDOM_1[26:23];	// @[ScratchpadSlavePort.scala:55:18]
        acq_data = {_RANDOM_1[31:27], _RANDOM_2[26:0]};	// @[ScratchpadSlavePort.scala:55:18]
        bundleIn_0_d_bits_data_r = {_RANDOM_2[31:28], _RANDOM_3[27:0]};	// @[Reg.scala:19:16, ScratchpadSlavePort.scala:55:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_a_ready = tl_in_a_ready;	// @[ScratchpadSlavePort.scala:104:35]
