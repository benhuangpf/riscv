...
module TSIToTileLink(
  ...
  wire        _T_22 = state == 4'h6;	// @[TSIToTileLink.scala:58:22, package.scala:16:47]
  wire        _T_18 = state == 4'h5;	// @[TSIToTileLink.scala:58:22, :62:29]
  wire [63:0] _GEN = {32'h0, addr[31:2] + 30'h1, 2'h0};	// @[Bundles.scala:259:74, Cat.scala:33:92, TSIToTileLink.scala:48:17, :65:22, :66:31, :69:28]
  ...
  wire [1:0]  rsize = raw_size == 66'h2 ? 2'h1 : {raw_size != 66'h1, 1'h0};	// @[Mux.scala:81:{58,61}, TSIToTileLink.scala:47:16, :71:21]
  ...
  wire [94:0] _GEN_2 = {63'h0, io_tsi_in_bits};	// @[TSIToTileLink.scala:94:12]
  ...
  wire        _T_19 = _T_18 & io_tsi_out_ready;	// @[TSIToTileLink.scala:62:29, :144:31]
  wire        _T_23 = _T_22 & io_tsi_in_valid;	// @[TSIToTileLink.scala:151:32, package.scala:16:47]
  wire        _T_26 = ~idx | ~(|len);	// @[TSIToTileLink.scala:49:16, :52:16, :147:15, :154:{15,42,49}]
  wire        _GEN_4 = ~_T_23 | _T_26;	// @[TSIToTileLink.scala:144:52, :151:{32,52}, :154:{42,58}]
  wire        _T_30 = _T_29 & auto_out_d_valid;	// @[TSIToTileLink.scala:166:31, package.scala:16:47]
  wire        _GEN_5 = _T_30 & (|len);	// @[TSIToTileLink.scala:49:16, :108:46, :137:47, :140:10, :147:15, :166:{31,47}, :167:24, :170:12]
  wire        _GEN_6 = ~_T_30 | ~(|len);	// @[TSIToTileLink.scala:49:16, :147:15, :151:52, :166:{31,47}, :167:{15,24}]
  wire [94:0] _addr_T_2 = _GEN_2 << _GEN_3;	// @[TSIToTileLink.scala:94:12]
  wire [94:0] _len_T_2 = _GEN_2 << _GEN_3;	// @[TSIToTileLink.scala:94:12]
  wire        _GEN_7 = _T_3 & idx;	// @[TSIToTileLink.scala:52:16, :100:45, :108:{26,46}, :111:43, :113:13]
  always @(posedge clock) begin
    ...
    if (_GEN_5 | _T_16)	// @[TSIToTileLink.scala:108:46, :137:{31,47}, :140:10, :166:47, :167:24, :170:12]
      ...
      addr <= 64'h0;	// @[TSIToTileLink.scala:48:17, :103:10]
    if (_GEN_5)	// @[TSIToTileLink.scala:108:46, :137:47, :140:10, :166:47, :167:24, :170:12]
      len <= len - 64'h1;	// @[TSIToTileLink.scala:49:16, :171:18]
    else if (_GEN_4) begin	// @[TSIToTileLink.scala:144:52, :151:52, :154:58]
      if (_T_19)	// @[TSIToTileLink.scala:144:31]
    ...
    bodyValid <= _GEN_6 & (_T_23 ? bodyValid | ~idx : ~(_T_6 & idx & _T_8) & bodyValid);	// @[TSIToTileLink.scala:51:22, :52:16, :110:9, :111:43, :112:11, :117:{25,45}, :120:43, :122:{17,32}, :123:19, :151:{32,52}, :153:{15,28}, :166:47, :167:24]
    idx <= _GEN_6 & (_GEN_4 ? (_T_19 ? idx - 1'h1 : ~_T_16 & (_T_6 ? ~idx & idx - 1'h1 : _T_3 ? ~idx & idx - 1'h1 : ~_T_1 & idx)) : idx - 1'h1);	// @[TSIToTileLink.scala:52:16, :100:{25,45}, :102:9, :108:{26,46}, :110:{9,16}, :111:43, :112:11, :117:{25,45}, :119:{9,16}, :120:43, :121:11, :137:{31,47}, :139:9, :144:{31,52}, :145:{9,16}, :151:52, :154:58, :157:18, :166:47, :167:24]
    if (reset)
    ...
    else if (_T_23 & _T_26)	// @[TSIToTileLink.scala:144:52, :151:{32,52}, :154:{42,58}, :155:13]
      state <= 4'h7;	// @[TSIToTileLink.scala:58:22, package.scala:16:47]
    else if (_T_19) begin	// @[TSIToTileLink.scala:144:31]
        ...
        if (idx) begin	// @[TSIToTileLink.scala:52:16]
          if (_T_16)	// @[TSIToTileLink.scala:137:31]
            ...
            if (_T_8)	// @[TSIToTileLink.scala:122:17]
              ...
              if (_GEN_7)	// @[TSIToTileLink.scala:100:45, :108:46, :111:43, :113:13]
          ...
          else if (_GEN_7)	// @[TSIToTileLink.scala:100:45, :108:46, :111:43, :113:13]
            state <= 4'h2;	// @[TSIToTileLink.scala:58:22, package.scala:16:47]
          else if (_T_1)	// @[TSIToTileLink.scala:100:25]
            state <= 4'h1;	// @[TSIToTileLink.scala:58:22, package.scala:16:47]
        end
  ...
  assign auto_out_a_bits_data = _T_27 ? body_0 : 32'h0;	// @[Bundles.scala:259:74, TSIToTileLink.scala:50:17, :86:20, package.scala:16:47]
  assign auto_out_d_ready = _T_29 | _T_15;	// @[package.scala:16:47, :73:59]
  assign io_tsi_in_ready = _T | _T_2 | _T_5 | _T_22;	// @[package.scala:16:47, :73:59]
  assign io_tsi_out_valid = _T_18;	// @[TSIToTileLink.scala:62:29]
  assign io_tsi_out_bits = body_0;	// @[TSIToTileLink.scala:50:17]
endmodule
