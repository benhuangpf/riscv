...
module TLXbar_4(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 6'h20;	// @[Parameters.scala:46:9, Xbar.scala:427:24]
  wire        out_7_valid = auto_out_d_valid & ~(auto_out_d_bits_source[5]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  ...
  TLMonitor_15 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[4:0]),	// @[Xbar.scala:231:69]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  TLMonitor_16 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[4:0];	// @[Xbar.scala:231:69]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 6'h0) | {muxStateEarly_1, 5'h0};	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:240:29, :265:23]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 4'h0) | {4{muxStateEarly_1}};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_corrupt = muxStateEarly_0 & auto_in_0_a_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_d_ready = ~(auto_out_d_bits_source[5]) & auto_in_0_d_ready | requestDOI_0_1;	// @[Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}]
endmodule
