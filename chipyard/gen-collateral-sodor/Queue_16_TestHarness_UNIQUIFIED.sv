...
module Queue_16_TestHarness_UNIQUIFIED(
  input         clock,
                reset,
                io_enq_valid,
  ...
  wire [44:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_1_TestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[11];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[43:12];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[44];	// @[Decoupled.scala:273:95]
endmodule
