...
module TLFragmenter_6(
  ...
  wire        drop = ~(auto_out_d_bits_opcode[0]) & (|(auto_out_d_bits_source[3:0]));	// @[Edges.scala:106:36, Fragmenter.scala:194:41, :196:30, :224:{20,30}]
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// @[Decoupled.scala:51:35]
        if (dFirst)	// @[Fragmenter.scala:195:29]
          ...
          acknum <= acknum - {3'h0, auto_out_d_bits_opcode[0] | auto_out_d_bits_size == 2'h2};	// @[Edges.scala:106:36, Fragmenter.scala:191:29, :206:{32,56}, :211:55, Mux.scala:27:73, OneHot.scala:64:{12,27}]
      end
  ...
  TLMonitor_27 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[10:5])	// @[Fragmenter.scala:228:47]
  );
  Repeater_6 repeater (	// @[Fragmenter.scala:264:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[10:5];	// @[Fragmenter.scala:228:47]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {15'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[1:0])} | 6'h3)};	// @[Fragmenter.scala:264:30, :295:30, :306:{49,51,100,111}, package.scala:235:{46,71,76}]
