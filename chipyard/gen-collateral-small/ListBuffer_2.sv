...
module ListBuffer_2(
  ...
  input  [4:0]  io_push_bits_data_source,
  ...
  reg  [14:0] valid;	// @[ListBuffer.scala:46:22]
  reg  [34:0] used;	// @[ListBuffer.scala:49:22]
  wire [34:0] _freeOH_T_22 = ~used;	// @[ListBuffer.scala:49:22, :53:25]
  wire [34:0] _freeOH_T_3 = _freeOH_T_22 | {_freeOH_T_22[33:0], 1'h0};	// @[ListBuffer.scala:53:25, package.scala:245:{43,53}]
  wire [34:0] _freeOH_T_6 = _freeOH_T_3 | {_freeOH_T_3[32:0], 2'h0};	// @[package.scala:245:{43,48,53}]
  wire [34:0] _freeOH_T_9 = _freeOH_T_6 | {_freeOH_T_6[30:0], 4'h0};	// @[package.scala:245:{43,48,53}]
  wire [34:0] _freeOH_T_12 = _freeOH_T_9 | {_freeOH_T_9[26:0], 8'h0};	// @[package.scala:245:{43,48,53}]
  wire [34:0] _freeOH_T_15 = _freeOH_T_12 | {_freeOH_T_12[18:0], 16'h0};	// @[package.scala:245:{43,48,53}]
  wire [35:0] freeOH = {~(_freeOH_T_15 | {_freeOH_T_15[2:0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// @[ListBuffer.scala:53:{16,25,32,38}, package.scala:245:{43,48,53}]
  wire [30:0] _GEN = {28'h0, freeOH[35:33]} | freeOH[31:1];	// @[ListBuffer.scala:53:38, OneHot.scala:31:18, :32:28]
  ...
  wire [5:0]  data_MPORT_addr = {|(freeOH[35:32]), |(_GEN[30:15]), |(_GEN_0[14:7]), |(_GEN_1[6:3]), |(_GEN_2[2:1]), _GEN_2[2] | _GEN_2[0]};	// @[Cat.scala:33:92, ListBuffer.scala:53:38, OneHot.scala:30:18, :31:18, :32:{14,28}]
  wire [14:0] _push_valid_T = valid >> io_push_bits_index;	// @[ListBuffer.scala:46:22, :62:25]
  wire        _io_push_ready_output = used != 35'h7FFFFFFFF;	// @[ListBuffer.scala:49:22, :53:25, :64:26]
  wire        data_MPORT_en = _io_push_ready_output & io_push_valid;	// @[Decoupled.scala:51:35, ListBuffer.scala:64:26]
  wire [15:0] _valid_clr_T = 16'h1 << io_pop_bits;	// @[OneHot.scala:64:12]
  wire [15:0] _valid_set_T = 16'h1 << io_push_bits_index;	// @[OneHot.scala:64:12]
  wire [63:0] _used_clr_T = 64'h1 << _head_ext_R0_data;	// @[ListBuffer.scala:47:18, OneHot.scala:64:12]
  always @(posedge clock) begin
    if (reset) begin
      valid <= 15'h0;	// @[ListBuffer.scala:46:22]
      used <= 35'h0;	// @[ListBuffer.scala:49:22]
    end
    else begin
      valid <= valid & ~(io_pop_valid & _head_ext_R0_data == _tail_ext_R0_data ? _valid_clr_T[14:0] : 15'h0) | (data_MPORT_en ? _valid_set_T[14:0] : 15'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:46:22, :47:18, :48:18, :56:30, :57:30, :65:23, :66:15, :87:22, :89:{20,48}, :90:17, :98:{21,23,35}, OneHot.scala:64:{12,27}]
      used <= used & ~(io_pop_valid ? _used_clr_T[34:0] : 35'h0) | (data_MPORT_en ? freeOH[34:0] : 35'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:49:22, :53:38, :58:30, :59:30, :65:23, :67:14, :87:22, :88:14, :97:{21,23,35}, OneHot.scala:64:{12,27}]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    wire  [14:0] _T_2 = valid >> io_pop_bits;	// @[ListBuffer.scala:46:22, :85:37]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        valid = _RANDOM_0[14:0];	// @[ListBuffer.scala:46:22]
        used = {_RANDOM_0[31:15], _RANDOM_1[17:0]};	// @[ListBuffer.scala:46:22, :49:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_data_source = _data_ext_R0_data[17:13];	// @[ListBuffer.scala:51:18]
  assign io_data_tag = _data_ext_R0_data[29:18];	// @[ListBuffer.scala:51:18]
