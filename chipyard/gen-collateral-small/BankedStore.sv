...
module BankedStore(
  ...
  wire [31:0] _cc_banks_3_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  wire [31:0] _cc_banks_2_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  wire [31:0] _cc_banks_1_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  wire [31:0] _cc_banks_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  wire [14:0] reqs_0_index = {io_sinkC_adr_bits_way, io_sinkC_adr_bits_set, io_sinkC_adr_bits_beat[3:2]};	// @[BankedStore.scala:135:23]
  ...
  wire [14:0] reqs_2_index = {io_sinkD_adr_bits_way, io_sinkD_adr_bits_set, io_sinkD_adr_bits_beat[3:2]};	// @[BankedStore.scala:135:23]
  ...
  wire [14:0] reqs_1_index = {io_sourceC_adr_bits_way, io_sourceC_adr_bits_set, io_sourceC_adr_bits_beat[3:2]};	// @[BankedStore.scala:135:23]
  ...
  wire [14:0] reqs_4_index = {io_sourceD_radr_bits_way, io_sourceD_radr_bits_set, io_sourceD_radr_bits_beat[3:2]};	// @[BankedStore.scala:135:23]
  ...
  wire [14:0] reqs_3_index = {io_sourceD_wadr_bits_way, io_sourceD_wadr_bits_set, io_sourceD_wadr_bits_beat[3:2]};	// @[BankedStore.scala:135:23]
  ...
  reg  [31:0] regout_r;	// @[Reg.scala:19:16]
  ...
  reg  [31:0] regout_r_1;	// @[Reg.scala:19:16]
  ...
  reg  [31:0] regout_r_2;	// @[Reg.scala:19:16]
  ...
  reg  [31:0] regout_r_3;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        regout_r = {_RANDOM_0[31:1], _RANDOM_1[0]};	// @[BankedStore.scala:172:47, Reg.scala:19:16]
        regout_REG_1 = _RANDOM_1[1];	// @[BankedStore.scala:172:47, Reg.scala:19:16]
        regout_r_1 = {_RANDOM_1[31:2], _RANDOM_2[1:0]};	// @[Reg.scala:19:16]
        regout_REG_2 = _RANDOM_2[2];	// @[BankedStore.scala:172:47, Reg.scala:19:16]
        regout_r_2 = {_RANDOM_2[31:3], _RANDOM_3[2:0]};	// @[Reg.scala:19:16]
        regout_REG_3 = _RANDOM_3[3];	// @[BankedStore.scala:172:47, Reg.scala:19:16]
        regout_r_3 = {_RANDOM_3[31:4], _RANDOM_4[3:0]};	// @[Reg.scala:19:16]
        regsel_sourceC_REG = _RANDOM_4[7:4];	// @[BankedStore.scala:175:39, Reg.scala:19:16]
        regsel_sourceC = _RANDOM_4[11:8];	// @[BankedStore.scala:175:31, Reg.scala:19:16]
        regsel_sourceD_REG = _RANDOM_4[15:12];	// @[BankedStore.scala:176:39, Reg.scala:19:16]
        regsel_sourceD = _RANDOM_4[19:16];	// @[BankedStore.scala:176:31, Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  cc_banks_0 cc_banks_0 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata (reqs_1_bankSum[0] ? io_sinkC_dat_data : reqs_1_bankSel[0] ? 32'h0 : reqs_2_bankSel[0] ? io_sinkD_dat_data : reqs_3_bankSel[0] ? io_sourceD_wdat_data : 32'h0),	// @[BankedStore.scala:136:24, :138:18, :166:33, Mux.scala:47:70]
  ...
  cc_banks_1 cc_banks_1 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata (reqs_1_bankSum[1] ? io_sinkC_dat_data : reqs_1_bankSel[1] ? 32'h0 : reqs_2_bankSel[1] ? io_sinkD_dat_data : reqs_3_bankSel[1] ? io_sourceD_wdat_data : 32'h0),	// @[BankedStore.scala:136:24, :138:18, :166:33, Mux.scala:47:70]
  ...
  cc_banks_2 cc_banks_2 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata (reqs_1_bankSum[2] ? io_sinkC_dat_data : reqs_1_bankSel[2] ? 32'h0 : reqs_2_bankSel[2] ? io_sinkD_dat_data : reqs_3_bankSel[2] ? io_sourceD_wdat_data : 32'h0),	// @[BankedStore.scala:136:24, :138:18, :166:33, Mux.scala:47:70]
  ...
  cc_banks_3 cc_banks_3 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata (reqs_1_bankSum[3] ? io_sinkC_dat_data : reqs_1_bankSel[3] ? 32'h0 : reqs_2_bankSel[3] ? io_sinkD_dat_data : reqs_3_bankSel[3] ? io_sourceD_wdat_data : 32'h0),	// @[BankedStore.scala:136:24, :138:18, :166:33, Mux.scala:47:70]
  ...
  assign io_sourceC_dat_data = (regsel_sourceC[0] ? regout_r : 32'h0) | (regsel_sourceC[1] ? regout_r_1 : 32'h0) | (regsel_sourceC[2] ? regout_r_2 : 32'h0) | (regsel_sourceC[3] ? regout_r_3 : 32'h0);	// @[BankedStore.scala:138:18, :175:31, :179:{23,38}, :180:85, Reg.scala:19:16]
  assign io_sourceD_radr_ready = _sourceD_rreq_io_sourceD_radr_ready_T_1[0];	// @[BankedStore.scala:132:21]
  assign io_sourceD_rdat_data = (regsel_sourceD[0] ? regout_r : 32'h0) | (regsel_sourceD[1] ? regout_r_1 : 32'h0) | (regsel_sourceD[2] ? regout_r_2 : 32'h0) | (regsel_sourceD[3] ? regout_r_3 : 32'h0);	// @[BankedStore.scala:138:18, :176:31, :186:{23,38}, :187:85, Reg.scala:19:16]
