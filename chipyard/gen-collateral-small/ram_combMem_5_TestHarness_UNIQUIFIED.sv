...
module ram_combMem_5_TestHarness_UNIQUIFIED(	// @[Decoupled.scala:273:95]
  input         R0_addr,
                R0_en,
                R0_clk,
                W0_addr,
  ...
  reg [46:0] Memory[0:1];	// @[Decoupled.scala:273:95]
  ...
  `ifndef SYNTHESIS	// @[Decoupled.scala:273:95]
    `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
      ...
      reg [63:0] _RANDOM_MEM;	// @[Decoupled.scala:273:95]
    `endif // RANDOMIZE_MEM_INIT
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 2; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[46:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 47'bx;	// @[Decoupled.scala:273:95]
endmodule
