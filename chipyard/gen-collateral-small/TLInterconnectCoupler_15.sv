...
module TLInterconnectCoupler_15(
  ...
  input  [31:0] auto_fixer_out_d_bits_data,
  ...
  output [3:0]  auto_fixer_out_a_bits_mask,
  output [31:0] auto_fixer_out_a_bits_data,
  ...
  wire [5:0]  _fragmenter_auto_in_d_bits_source;	// @[Fragmenter.scala:335:34]
  wire [31:0] _fragmenter_auto_in_d_bits_data;	// @[Fragmenter.scala:335:34]
  ...
  wire [31:0] _fixer_auto_in_d_bits_data;	// @[FIFOFixer.scala:146:27]
