...
module TLMonitor_23(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [32:0]     _GEN_27 = {27'h0, io_in_d_bits_source};	// @[Monitor.scala:682:25, Parameters.scala:137:65]
    wire             _GEN_28 = _T_757 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [32:0]     _T_758 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [32:0]     _T_844 = 33'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_WIRE_2_1 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(_WIRE_2_1 & io_in_a_bits_size == 3'h6 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :671:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:19], _RANDOM_1[12:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[16:13];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_1[30:25];	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_1[31];	// @[Monitor.scala:388:22, :539:22]
        denied = _RANDOM_2[0];	// @[Monitor.scala:540:22]
        inflight = {_RANDOM_2[31:1], _RANDOM_3[1:0]};	// @[Monitor.scala:540:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:2], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[5:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_7[31:6], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11[9:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_11[13:10];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_11[17:14];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_11[31:18], _RANDOM_12[17:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_21[31], _RANDOM_22[2:0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
