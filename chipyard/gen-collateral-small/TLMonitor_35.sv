...
module TLMonitor_35(
  ...
  wire [16398:0] _GEN_1 = {16386'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:122:25, :677:76]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [1:0]      _GEN_4 = io_in_a_bits_address[1:0] & ~(_is_aligned_mask_T_1[1:0]);	// @[Edges.scala:21:16, package.scala:235:{46,71,76}]
    ...
    wire             _GEN_6 = io_in_a_bits_source > 11'h41F;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_17 = io_in_d_bits_source > 11'h41F;	// @[Parameters.scala:57:20]
    ...
    wire  [4223:0]   _GEN_20 = {4211'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:122:25, :634:44]
    wire  [4223:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_20;	// @[Monitor.scala:613:35, :634:44]
    wire  [2047:0]   _a_set_wo_ready_T = 2048'h1 << _GEN;	// @[OneHot.scala:57:35]
    wire  [1055:0]   a_set_wo_ready = io_in_a_valid ? _a_set_wo_ready_T[1055:0] : 1056'h0;	// @[Monitor.scala:624:34, :648:71, :649:22, :723:35, OneHot.scala:57:35]
    ...
    wire  [1055:0]   _GEN_21 = {1045'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [1055:0]   _T_618 = inflight >> _GEN_21;	// @[Monitor.scala:611:27, :682:25]
    wire  [4223:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_20;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [2047:0]   _d_clr_wo_ready_T = 2048'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire  [1055:0]   _T_704 = 1056'h0 >> _GEN_21;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [4223:0]   _c_size_lookup_T_1 = 4224'h0 >> _GEN_20;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(io_in_a_bits_size != 2'h3 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:{31,65}, :671:54, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 11'h420 & io_in_a_bits_size != 2'h3 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_source < 11'h420 & io_in_a_bits_size != 2'h3 & io_in_a_bits_address[25:12] == 14'h2010)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}, package.scala:235:64]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_22 & ~reset & ~(io_in_d_bits_opcode == _GEN_3[io_in_a_bits_opcode] | io_in_d_bits_opcode == _GEN_2[io_in_a_bits_opcode])) begin	// @[Monitor.scala:49:11, :684:30, :685:{38,77}, :686:39]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_23 & ~reset & ~(io_in_d_bits_opcode == _GEN_3[_a_opcode_lookup_T_1[3:1]] | io_in_d_bits_opcode == _GEN_2[_a_opcode_lookup_T_1[3:1]])) begin	// @[Monitor.scala:49:11, :634:44, :684:30, :685:38, :686:39, :689:{38,72}, :690:38]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at Configs.scala:128:9)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      ...
      if (~reset & ~(a_set_wo_ready != (io_in_d_valid & ~d_release_ack ? _d_clr_wo_ready_T[1055:0] : 1056'h0) | a_set_wo_ready == 1056'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
