  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = _RANDOM_0[27:16];	// @[Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM_0[31:28];	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_2[0];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
