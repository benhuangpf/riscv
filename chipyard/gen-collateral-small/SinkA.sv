...
module SinkA(
  ...
  output        io_a_ready,
                io_pb_pop_ready,
  output [31:0] io_pb_beat_data,
  output [3:0]  io_pb_beat_mask,
  ...
  wire [39:0] _freeOH_T_9 = _freeOH_T_6 | {_freeOH_T_6[35:0], 4'h0};	// @[Edges.scala:229:27, package.scala:245:{43,53}]
  ...
  reg  [3:0]  first_counter;	// @[Edges.scala:229:27]
  wire        first = first_counter == 4'h0;	// @[Edges.scala:229:27, :231:25]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      first_counter <= 4'h0;	// @[Edges.scala:229:27]
    end
    else begin
      ...
      if (_io_a_ready_output & io_a_valid) begin	// @[Decoupled.scala:51:35, SinkA.scala:78:39]
        if (first) begin	// @[Edges.scala:231:25]
          if (io_a_bits_opcode[2])	// @[Edges.scala:92:37]
            ...
            first_counter <= ~(_first_beats1_decode_T_1[5:2]);	// @[Edges.scala:229:27, package.scala:235:{46,71,76}]
        end
        else	// @[Edges.scala:231:25]
          first_counter <= first_counter - 4'h1;	// @[Edges.scala:229:27, :230:28]
      end
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        first_counter = _RANDOM_1[11:8];	// @[Edges.scala:229:27, SinkA.scala:52:22]
        put_r = _RANDOM_1[17:12];	// @[Reg.scala:19:16, SinkA.scala:52:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_req_bits_tag = io_a_bits_address[27:16];	// @[Cat.scala:33:92, Parameters.scala:214:22, :215:19]
