...
module Queue_17(
  ...
  wire [6:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_tl_state_source, io_enq_bits_tl_state_size}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[6:4];	// @[Decoupled.scala:273:95]
endmodule
