...
module Queue_38(
  ...
  assign io_deq_bits_beat = _ram_ext_R0_data[17:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[18];	// @[Decoupled.scala:273:95]
endmodule
