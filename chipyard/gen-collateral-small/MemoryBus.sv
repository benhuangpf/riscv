...
module MemoryBus(
  ...
  wire [2:0]  _coupler_to_memory_controller_port_named_axi4_auto_widget_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [2:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [2:0]  _coupler_to_memory_controller_port_named_axi4_auto_tl_out_a_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [2:0]  _picker_auto_in_d_bits_source;	// @[ProbePicker.scala:66:28]
  ...
  wire [2:0]  _picker_auto_out_a_bits_source;	// @[ProbePicker.scala:66:28]
  ...
  wire [2:0]  _fixer_auto_out_a_bits_source;	// @[FIFOFixer.scala:146:27]
