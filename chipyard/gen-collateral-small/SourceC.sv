...
module SourceC(
  ...
  output [3:0]  io_bs_adr_bits_beat,
  ...
  wire [4:0]  _queue_io_count;	// @[SourceC.scala:54:21]
  reg  [4:0]  fill;	// @[SourceC.scala:58:21]
  reg         room;	// @[SourceC.scala:59:21]
  reg         busy;	// @[SourceC.scala:66:21]
  reg  [3:0]  beat;	// @[SourceC.scala:67:21]
  reg  [2:0]  req_r_opcode;	// @[Reg.scala:19:16]
  reg  [2:0]  req_r_param;	// @[Reg.scala:19:16]
  reg  [1:0]  req_r_source;	// @[Reg.scala:19:16]
  reg  [11:0] req_r_tag;	// @[Reg.scala:19:16]
  ...
  reg  [11:0] s2_req_tag;	// @[Reg.scala:19:16]
  ...
  reg  [11:0] s3_req_tag;	// @[Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      fill <= 5'h0;	// @[SourceC.scala:58:21]
      room <= 1'h1;	// @[SourceC.scala:59:21]
      busy <= 1'h0;	// @[SourceC.scala:62:18, :66:21]
      beat <= 4'h0;	// @[SourceC.scala:67:21]
    end
    else begin
      if (_room_T_4 != (io_c_ready & _queue_io_deq_valid)) begin	// @[Decoupled.scala:51:35, SourceC.scala:54:21, :60:27]
        fill <= fill + (_room_T_4 ? 5'h1 : 5'h1F);	// @[Decoupled.scala:51:35, SourceC.scala:58:21, :61:{18,23,48}]
        room <= fill == 5'h0 | (fill == 5'h1 | fill == 5'h2) & ~_room_T_4;	// @[Decoupled.scala:51:35, SourceC.scala:58:21, :59:21, :61:23, :62:{18,26,36,44,52,61,64}]
      end
      ...
      if (_s2_latch_T)	// @[Decoupled.scala:51:35]
        beat <= beat + 4'h1;	// @[SourceC.scala:61:23, :67:21, :90:18]
    end
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[SourceC.scala:64:10]
      if (~reset & room != (_queue_io_count < 5'h2)) begin	// @[SourceC.scala:54:21, :59:21, :62:52, :64:{10,16,35}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_2 = `RANDOM;
        _RANDOM_3 = `RANDOM;
        fill = _RANDOM_0[4:0];	// @[SourceC.scala:58:21]
        room = _RANDOM_0[5];	// @[SourceC.scala:58:21, :59:21]
        busy = _RANDOM_0[6];	// @[SourceC.scala:58:21, :66:21]
        beat = _RANDOM_0[10:7];	// @[SourceC.scala:58:21, :67:21]
        req_r_opcode = _RANDOM_0[13:11];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_param = _RANDOM_0[16:14];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_source = _RANDOM_0[18:17];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_tag = _RANDOM_0[30:19];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_set = {_RANDOM_0[31], _RANDOM_1[8:0]};	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_way = _RANDOM_1[11:9];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_1[13];	// @[Reg.scala:19:16, SourceC.scala:94:25]
        s2_req_opcode = _RANDOM_1[16:14];	// @[Reg.scala:19:16]
        s2_req_param = _RANDOM_1[19:17];	// @[Reg.scala:19:16]
        s2_req_source = _RANDOM_1[21:20];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:22], _RANDOM_2[1:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_2[11:2];	// @[Reg.scala:19:16]
        s3_valid = _RANDOM_2[21];	// @[Reg.scala:19:16, SourceC.scala:100:25]
        s3_req_opcode = _RANDOM_2[24:22];	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_2[27:25];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_2[29:28];	// @[Reg.scala:19:16]
        s3_req_tag = {_RANDOM_2[31:30], _RANDOM_3[9:0]};	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_3[19:10];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_33 queue (	// @[SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({4'h0, s3_req_tag, s3_req_set, 6'h0}),	// @[Cat.scala:33:92, Parameters.scala:220:15, Reg.scala:19:16, SourceC.scala:67:21]
