...
module TLToAXI4(
  ...
  wire [2:0]      _queue_arw_deq_io_deq_bits_id;	// @[Decoupled.scala:375:21]
  ...
  wire [2:0]      _queue_arw_deq_io_deq_bits_echo_tl_state_source;	// @[Decoupled.scala:375:21]
  wire            _queue_arw_deq_io_deq_bits_wen;	// @[Decoupled.scala:375:21]
  wire            _deq_io_enq_ready;	// @[Decoupled.scala:375:21]
  wire [7:0][2:0] _GEN = '{3'h0, 3'h0, 3'h5, 3'h4, 3'h3, 3'h2, 3'h1, 3'h0};	// @[ToAXI4.scala:169:17]
  ...
  wire [2:0]      out_arw_bits_id = _GEN[auto_in_a_bits_source];	// @[ToAXI4.scala:169:17]
  wire [16:0]     _out_arw_bits_len_T_1 = 17'h3FF << auto_in_a_bits_size;	// @[package.scala:235:71]
  wire [7:0]      _GEN_0 = {{count_1}, {count_1}, {count_6}, {count_5}, {count_4}, {count_3}, {count_2}, {count_1}};	// @[ToAXI4.scala:198:49, :257:28]
  ...
  wire [2:0]      bundleIn_0_d_bits_opcode = {2'h0, r_wins};	// @[ToAXI4.scala:218:53, :230:39, :240:23]
  ...
  wire [2:0]      bundleIn_0_d_bits_source = r_wins ? auto_out_r_bits_echo_tl_state_source : auto_out_b_bits_echo_tl_state_source;	// @[ToAXI4.scala:218:53, :240:23]
  ...
  wire [2:0]      d_sel_shiftAmount = r_wins ? auto_out_r_bits_id : auto_out_b_bits_id;	// @[ToAXI4.scala:218:53, :246:31]
  wire            d_last = ~r_wins | auto_out_r_bits_last;	// @[ToAXI4.scala:218:53, :247:23]
  wire            _inc_T_5 = _queue_arw_deq_io_enq_ready & out_arw_valid;	// @[Decoupled.scala:51:35, :375:21, ToAXI4.scala:200:45]
  wire            inc = out_arw_bits_id == 3'h0 & _inc_T_5;	// @[Bundles.scala:259:74, Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:169:17, :245:58, :261:22]
  wire            _dec_T_11 = auto_in_d_ready & bundleIn_0_d_valid;	// @[Decoupled.scala:51:35, ToAXI4.scala:222:24]
  wire            dec = d_sel_shiftAmount == 3'h0 & d_last & _dec_T_11;	// @[Bundles.scala:259:74, Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire            inc_1 = out_arw_bits_id == 3'h1 & _inc_T_5;	// @[Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:169:17, :176:17, :245:58, :261:22]
  wire            dec_1 = d_sel_shiftAmount == 3'h1 & d_last & _dec_T_11;	// @[Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:176:17, :246:{31,93}, :247:23, :262:32]
  wire            inc_2 = out_arw_bits_id == 3'h2 & _inc_T_5;	// @[Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:119:39, :169:17, :245:58, :261:22]
  wire            dec_2 = d_sel_shiftAmount == 3'h2 & d_last & _dec_T_11;	// @[Decoupled.scala:51:35, OneHot.scala:64:27, ToAXI4.scala:119:39, :246:{31,93}, :247:23, :262:32]
  wire            inc_3 = out_arw_bits_id == 3'h3 & _inc_T_5;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire            dec_3 = d_sel_shiftAmount == 3'h3 & d_last & _dec_T_11;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire            inc_4 = out_arw_bits_id == 3'h4 & _inc_T_5;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire            dec_4 = d_sel_shiftAmount == 3'h4 & d_last & _dec_T_11;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  wire            inc_5 = out_arw_bits_id == 3'h5 & _inc_T_5;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:169:17, :245:58, :261:22]
  wire            dec_5 = d_sel_shiftAmount == 3'h5 & d_last & _dec_T_11;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  ...
  Queue_29 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_30 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
    ...
    .io_enq_bits_size                 ((|(auto_in_a_bits_size[2:1])) ? 3'h2 : auto_in_a_bits_size),	// @[ToAXI4.scala:119:39, :172:{23,31}]
