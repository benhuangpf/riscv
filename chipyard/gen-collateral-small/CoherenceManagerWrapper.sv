...
module CoherenceManagerWrapper(
  ...
  input  [3:0]  auto_l2_ctl_in_a_bits_mask,
  input  [31:0] auto_l2_ctl_in_a_bits_data,
  ...
  output [31:0] auto_l2_ctl_in_d_bits_data
);
  ...
  wire [2:0]  _binder_auto_in_d_bits_source;	// @[BankBinder.scala:68:28]
  wire        _binder_auto_in_d_bits_denied;	// @[BankBinder.scala:68:28]
  wire [31:0] _binder_auto_in_d_bits_data;	// @[BankBinder.scala:68:28]
  ...
  wire [1:0]  _cork_auto_in_d_bits_source;	// @[Configs.scala:105:26]
  wire [2:0]  _cork_auto_in_d_bits_sink;	// @[Configs.scala:105:26]
  wire        _cork_auto_in_d_bits_denied;	// @[Configs.scala:105:26]
  wire [31:0] _cork_auto_in_d_bits_data;	// @[Configs.scala:105:26]
  ...
  wire [2:0]  _cork_auto_out_a_bits_source;	// @[Configs.scala:105:26]
  wire [31:0] _cork_auto_out_a_bits_address;	// @[Configs.scala:105:26]
  wire [3:0]  _cork_auto_out_a_bits_mask;	// @[Configs.scala:105:26]
  wire [31:0] _cork_auto_out_a_bits_data;	// @[Configs.scala:105:26]
  ...
  wire [4:0]  _InclusiveCache_inner_TLBuffer_auto_out_a_bits_source;	// @[Parameters.scala:56:69]
  wire [31:0] _InclusiveCache_inner_TLBuffer_auto_out_a_bits_address;	// @[Parameters.scala:56:69]
  wire [3:0]  _InclusiveCache_inner_TLBuffer_auto_out_a_bits_mask;	// @[Parameters.scala:56:69]
  wire [31:0] _InclusiveCache_inner_TLBuffer_auto_out_a_bits_data;	// @[Parameters.scala:56:69]
  ...
  wire [4:0]  _InclusiveCache_inner_TLBuffer_auto_out_c_bits_source;	// @[Parameters.scala:56:69]
  wire [31:0] _InclusiveCache_inner_TLBuffer_auto_out_c_bits_address;	// @[Parameters.scala:56:69]
  wire [31:0] _InclusiveCache_inner_TLBuffer_auto_out_c_bits_data;	// @[Parameters.scala:56:69]
  ...
  wire [4:0]  _l2_auto_in_d_bits_source;	// @[Configs.scala:76:24]
  wire [2:0]  _l2_auto_in_d_bits_sink;	// @[Configs.scala:76:24]
  wire        _l2_auto_in_d_bits_denied;	// @[Configs.scala:76:24]
  wire [31:0] _l2_auto_in_d_bits_data;	// @[Configs.scala:76:24]
  ...
  wire [1:0]  _l2_auto_out_a_bits_source;	// @[Configs.scala:76:24]
  wire [31:0] _l2_auto_out_a_bits_address;	// @[Configs.scala:76:24]
  wire [3:0]  _l2_auto_out_a_bits_mask;	// @[Configs.scala:76:24]
  wire [31:0] _l2_auto_out_a_bits_data;	// @[Configs.scala:76:24]
  ...
  wire [1:0]  _l2_auto_out_c_bits_source;	// @[Configs.scala:76:24]
  wire [31:0] _l2_auto_out_c_bits_address;	// @[Configs.scala:76:24]
  wire [31:0] _l2_auto_out_c_bits_data;	// @[Configs.scala:76:24]
