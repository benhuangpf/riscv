...
module Queue_29(
  ...
  wire [36:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[31:0];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_strb = _ram_ext_R0_data[35:32];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[36];	// @[Decoupled.scala:273:95]
endmodule
