...
module Queue_5(
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[15:13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[48:17];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[49];	// @[Decoupled.scala:273:95]
endmodule
