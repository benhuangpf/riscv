...
module Queue_39(
  ...
  wire [46:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[9:8];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[12:10];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[45:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[46];	// @[Decoupled.scala:273:95]
endmodule
