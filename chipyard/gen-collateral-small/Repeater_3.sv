  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM_0[31:16], _RANDOM_1[11:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM_1[15:12];	// @[Repeater.scala:20:18]
        saved_corrupt = _RANDOM_2[16];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
