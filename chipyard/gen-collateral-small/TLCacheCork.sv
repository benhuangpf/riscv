...
module TLCacheCork(
  ...
  wire [1:0]  _q_1_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  wire [2:0]  _q_1_io_deq_bits_sink;	// @[Decoupled.scala:375:21]
  wire        _q_1_io_deq_bits_denied;	// @[Decoupled.scala:375:21]
  wire [31:0] _q_1_io_deq_bits_data;	// @[Decoupled.scala:375:21]
  ...
  wire [1:0]  _q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  wire [2:0]  _q_io_deq_bits_sink;	// @[Decoupled.scala:375:21]
  wire        _q_io_deq_bits_denied;	// @[Decoupled.scala:375:21]
  wire [31:0] _q_io_deq_bits_data;	// @[Decoupled.scala:375:21]
  ...
  wire        c_a_bits_a_mask_acc = (|(auto_in_c_bits_size[2:1])) | auto_in_c_bits_size[0] & ~(auto_in_c_bits_address[1]);	// @[Misc.scala:205:21, :209:26, :210:20, :214:{29,38}, OneHot.scala:63:49]
  wire        c_a_bits_a_mask_acc_1 = (|(auto_in_c_bits_size[2:1])) | auto_in_c_bits_size[0] & auto_in_c_bits_address[1];	// @[Misc.scala:205:21, :209:26, :214:{29,38}, OneHot.scala:63:49]
  ...
  wire [3:0]  _GEN = {{wSourceVec_0}, {wSourceVec_2}, {wSourceVec_1}, {wSourceVec_0}};	// @[CacheCork.scala:139:29, :143:25]
  wire        _GEN_0 = _GEN[auto_out_d_bits_source[2:1]];	// @[CacheCork.scala:135:46, :143:25]
  reg         dWHeld_r;	// @[Reg.scala:19:16]
  wire        _T_18 = auto_out_d_bits_opcode == 3'h1 & auto_out_d_bits_source[0];	// @[CacheCork.scala:81:52, :154:{33,51,71}]
  ...
  wire        idle = beatsLeft == 4'h0;	// @[Arbiter.scala:88:30, :89:28, Nodes.scala:1215:84]
  ...
  reg  [3:0]  beatsLeft_1;	// @[Arbiter.scala:88:30]
  wire        idle_1 = beatsLeft_1 == 4'h0;	// @[Arbiter.scala:88:30, :89:28, Nodes.scala:1215:84]
  ...
  wire [1:0]  out_6_bits_source = (muxStateEarly_1_0 ? auto_out_d_bits_source[2:1] : 2'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_source : 2'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_source : 2'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:135:46, Decoupled.scala:375:21, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      d_first_counter <= 4'h0;	// @[Edges.scala:229:27, Nodes.scala:1215:84]
      beatsLeft <= 4'h0;	// @[Arbiter.scala:88:30, Nodes.scala:1215:84]
      state_0 <= 1'h0;	// @[Arbiter.scala:117:26]
      state_1 <= 1'h0;	// @[Arbiter.scala:117:26]
      beatsLeft_1 <= 4'h0;	// @[Arbiter.scala:88:30, Nodes.scala:1215:84]
      ...
      if (idle & auto_out_a_ready)	// @[Arbiter.scala:89:28, :90:24]
        beatsLeft <= (winnerQual_0 ? ~(_decode_T_1[5:2]) : 4'h0) | (winnerQual_1 & ~(out_1_bits_opcode[2]) ? ~(_decode_T_5[5:2]) : 4'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, CacheCork.scala:74:18, :78:86, :79:27, :94:33, Edges.scala:92:{28,37}, :221:14, Nodes.scala:1215:84, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {3'h0, auto_out_a_ready & out_2_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Nodes.scala:1215:84, ReadyValidCancel.scala:49:33]
      ...
      if (idle_1 & out_6_ready) begin	// @[Arbiter.scala:89:28, :90:24, CacheCork.scala:128:34]
        if (auto_out_d_valid & out_3_bits_opcode[0])	// @[Arbiter.scala:112:73, CacheCork.scala:154:76, :158:73, :159:27, Edges.scala:106:36, :221:14]
          beatsLeft_1 <= ~(_decode_T_9[5:2]);	// @[Arbiter.scala:88:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:112:73, Edges.scala:221:14]
          beatsLeft_1 <= 4'h0;	// @[Arbiter.scala:88:30, Nodes.scala:1215:84]
      end
      else	// @[Arbiter.scala:90:24]
        beatsLeft_1 <= beatsLeft_1 - {3'h0, out_6_ready & out_6_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, CacheCork.scala:128:34, Nodes.scala:1215:84, ReadyValidCancel.scala:49:33]
    ...
    wSourceVec_0 <= _T_15 & auto_in_a_bits_source == 2'h0 | wSourceVec_0;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_1 <= _T_15 & auto_in_a_bits_source == 2'h1 | wSourceVec_1;	// @[CacheCork.scala:139:29, :145:26, :146:40, Decoupled.scala:51:35]
    wSourceVec_2 <= _T_15 & auto_in_a_bits_source == 2'h2 | wSourceVec_2;	// @[CacheCork.scala:69:73, :139:29, :145:26, :146:40, Decoupled.scala:51:35]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        d_first_counter = _RANDOM_0[3:0];	// @[Edges.scala:229:27]
        bundleIn_0_d_bits_sink_r = _RANDOM_0[6:4];	// @[Edges.scala:229:27, Reg.scala:19:16]
        wSourceVec_0 = _RANDOM_0[7];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_1 = _RANDOM_0[8];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        wSourceVec_2 = _RANDOM_0[9];	// @[CacheCork.scala:139:29, Edges.scala:229:27]
        dWHeld_r = _RANDOM_0[10];	// @[Edges.scala:229:27, Reg.scala:19:16]
        beatsLeft = _RANDOM_0[14:11];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
        state_0 = _RANDOM_0[15];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1 = _RANDOM_0[16];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        beatsLeft_1 = _RANDOM_0[20:17];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
        state_1_0 = _RANDOM_0[21];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1_1 = _RANDOM_0[22];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
        state_1_2 = _RANDOM_0[23];	// @[Arbiter.scala:117:26, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_39 q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_data    (32'h0),	// @[Nodes.scala:1215:84]
  ...
  Queue_39 q_1 (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_in_d_bits_data = (muxStateEarly_1_0 ? auto_out_d_bits_data : 32'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_data : 32'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {auto_in_c_bits_source, 1'h0} : 3'h0) | (muxStateEarly_1 ? {auto_in_a_bits_source, _T_2 | auto_in_a_bits_opcode == 3'h0 | auto_in_a_bits_opcode == 3'h1} : 3'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:68:{38,74}, :75:25, :78:{49,86}, :81:{27,52}, :96:41, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? {c_a_bits_a_mask_acc_1 | auto_in_c_bits_address[1] & auto_in_c_bits_address[0], c_a_bits_a_mask_acc_1 | auto_in_c_bits_address[1] & ~(auto_in_c_bits_address[0]), c_a_bits_a_mask_acc | ~(auto_in_c_bits_address[1]) & auto_in_c_bits_address[0], c_a_bits_a_mask_acc | ~(auto_in_c_bits_address[1]) & ~(auto_in_c_bits_address[0])} : 4'h0) | (muxStateEarly_1 ? auto_in_a_bits_mask : 4'h0);	// @[Arbiter.scala:118:30, Cat.scala:33:92, Misc.scala:209:26, :210:20, :213:27, :214:29, Mux.scala:27:73, Nodes.scala:1215:84]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? auto_in_c_bits_data : 32'h0) | (muxStateEarly_1 ? auto_in_a_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Nodes.scala:1215:84]
