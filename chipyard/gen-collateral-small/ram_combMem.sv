...
module ram_combMem(	// @[Decoupled.scala:273:95]
  ...
  reg [6:0] Memory[0:0];	// @[Decoupled.scala:273:95]
  ...
  `ifndef SYNTHESIS	// @[Decoupled.scala:273:95]
    `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
      ...
      reg [31:0] _RANDOM_MEM;	// @[Decoupled.scala:273:95]
    `endif // RANDOMIZE_MEM_INIT
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 1; initvar = initvar + 1) begin
          _RANDOM_MEM = {`RANDOM};
          Memory[initvar] = _RANDOM_MEM[6:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 7'bx;	// @[Decoupled.scala:273:95]
endmodule
