...
module Queue_1(
  ...
  wire [48:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[13:8];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[47:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[48];	// @[Decoupled.scala:273:95]
endmodule
