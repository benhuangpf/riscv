...
module ICache(
  ...
  wire [9:0]   beats1 = auto_master_out_d_bits_opcode[0] ? ~(_beats1_decode_T_1[11:2]) : 10'h0;	// @[Edges.scala:106:36, :221:14, :229:27, package.scala:235:{46,71,76}]
  reg  [9:0]   counter;	// @[Edges.scala:229:27]
  wire [9:0]   counter1 = counter - 10'h1;	// @[Edges.scala:229:27, :230:28]
  wire [9:0]   refill_cnt = beats1 & ~counter1;	// @[Edges.scala:221:14, :230:28, :234:{25,27}]
  wire         writeEnable_0 = refill_one_beat & (counter == 10'h1 | beats1 == 10'h0) & auto_master_out_d_valid;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}, ICache.scala:383:41, :391:37]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      counter <= 10'h0;	// @[Edges.scala:229:27]
      ...
      refill_valid <= ~writeEnable_0 & (auto_master_out_a_ready & tl_out_a_valid | refill_valid);	// @[Decoupled.scala:51:35, ICache.scala:360:29, :377:35, :391:37, :821:{22,37}, :822:{22,37}]
      if (auto_master_out_d_valid) begin
        if (counter == 10'h0) begin	// @[Edges.scala:229:27, :231:25]
      ...
      if (invalidate)	// @[ICache.scala:448:31, :644:{39,52}]
        ...
        vb_array <= writeEnable_0 & ~invalidated ? vb_array | _vb_array_T_3[63:0] : ~(~vb_array | _vb_array_T_3[63:0]);	// @[ICache.scala:359:24, :391:37, :440:25, :444:{32,72,75}]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = _RANDOM_3[21:12];	// @[Edges.scala:229:27]
        accruedRefillError = _RANDOM_3[22];	// @[Edges.scala:229:27, ICache.scala:420:31]
        vb_array = {_RANDOM_3[31:23], _RANDOM_4, _RANDOM_5[22:0]};	// @[Edges.scala:229:27, ICache.scala:440:25]
  ...
  data_arrays_0_0 data_arrays_0_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? {refill_paddr[11:6], 4'h0} | refill_cnt : io_req_bits_addr[11:2]),	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}, :850:21, Reg.scala:19:16]
