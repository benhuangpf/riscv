...
module Queue_47(
  ...
  wire [47:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[13:11];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[46:15];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[47];	// @[Decoupled.scala:273:95]
endmodule
