...
module TLXbar(
  ...
  wire [4:0]  portsAOI_filtered_1_bits_source = {1'h0, auto_in_0_a_bits_source};	// @[Xbar.scala:240:29]
  wire [4:0]  portsAOI_filtered_1_1_bits_source = {3'h4, auto_in_1_a_bits_source};	// @[Parameters.scala:54:32, Xbar.scala:240:55]
  ...
  wire        requestDOI_0_1 = auto_out_0_d_bits_source[4:2] == 3'h4;	// @[Parameters.scala:54:{10,32}]
  wire        requestDOI_1_1 = auto_out_1_d_bits_source[4:2] == 3'h4;	// @[Parameters.scala:54:{10,32}]
  ...
  wire        out_10_earlyValid = auto_out_0_d_valid & ~(auto_out_0_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_15_earlyValid = auto_out_0_d_valid & requestDOI_0_1;	// @[Parameters.scala:54:32, Xbar.scala:182:40]
  wire        out_11_earlyValid = auto_out_1_d_valid & ~(auto_out_1_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  wire        out_16_earlyValid = auto_out_1_d_valid & requestDOI_1_1;	// @[Parameters.scala:54:32, Xbar.scala:182:40]
  ...
  wire [3:0]  out_12_bits_size = (muxStateEarly_2_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_2_1 ? out_16_bits_size : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_1_d_bits_source = (muxStateEarly_3_0 ? auto_out_0_d_bits_source[1:0] : 2'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_source[1:0] : 2'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  wire [3:0]  out_17_bits_size = (muxStateEarly_3_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_3_1 ? out_16_bits_size : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch_2)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft_2 <= beatsLeft_2 - {9'h0, auto_in_0_d_ready & out_12_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
      ...
      if (latch_3)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft_3 <= beatsLeft_3 - {9'h0, auto_in_1_d_ready & out_17_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_1_d_bits_data = (muxStateEarly_3_0 ? auto_out_0_d_bits_data : 32'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_0_d_bits_data = (muxStateEarly_2_0 ? auto_out_0_d_bits_data : 32'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_1_a_bits_address = (muxStateEarly_1_0 ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_1_a_bits_data = (muxStateEarly_1_0 ? auto_in_0_a_bits_data : 32'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_0_a_bits_address = (muxStateEarly_0 ? auto_in_0_a_bits_address[30:0] : 31'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address[30:0] : 31'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_0_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
