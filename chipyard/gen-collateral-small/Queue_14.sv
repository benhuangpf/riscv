...
module Queue_14(
  ...
  wire [52:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[51:20];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[52];	// @[Decoupled.scala:273:95]
endmodule
