...
module Queue_8(
  ...
  wire [83:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[50:47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[82:51];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[83];	// @[Decoupled.scala:273:95]
endmodule
