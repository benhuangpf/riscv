...
module TLMonitor_22(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [4223:0]   _GEN_24 = {4211'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:122:25, :634:44]
    wire  [4223:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_24;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [1055:0]   _GEN_25 = {1045'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [3:0]      _GEN_28 = {2'h0, io_in_d_bits_size};	// @[Monitor.scala:122:25, :691:36]
    ...
    wire  [1055:0]   _T_618 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [4223:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [2047:0]   _d_clr_wo_ready_T = 2048'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire  [1055:0]   _T_704 = 1056'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [4223:0]   _c_size_lookup_T_1 = 4224'h0 >> _GEN_24;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_20 & ~reset & ~(io_in_d_bits_size[1])) begin	// @[Monitor.scala:49:11, :328:51, :331:27]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
