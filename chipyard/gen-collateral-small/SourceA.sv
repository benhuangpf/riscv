...
module SourceA(
  ...
  Queue_32 io_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({4'h0, io_req_bits_tag, io_req_bits_set, 6'h0}),	// @[Cat.scala:33:92, Parameters.scala:220:15, SourceA.scala:55:21]
