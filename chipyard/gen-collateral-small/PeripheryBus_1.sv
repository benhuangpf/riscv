...
module PeripheryBus_1(
  ...
  input  [31:0] auto_coupler_to_l2_ctrl_buffer_out_d_bits_data,
  ...
  output [3:0]  auto_coupler_to_l2_ctrl_buffer_out_a_bits_mask,
  output [31:0] auto_coupler_to_l2_ctrl_buffer_out_a_bits_data,
  ...
  wire [5:0]      _coupler_to_l2_ctrl_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [31:0]     _coupler_to_l2_ctrl_auto_tl_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire [5:0]      _out_xbar_auto_out_4_a_bits_source;	// @[PeripheryBus.scala:50:30]
  wire [25:0]     _out_xbar_auto_out_4_a_bits_address;	// @[PeripheryBus.scala:50:30]
  wire [3:0]      _out_xbar_auto_out_4_a_bits_mask;	// @[PeripheryBus.scala:50:30]
  wire [31:0]     _out_xbar_auto_out_4_a_bits_data;	// @[PeripheryBus.scala:50:30]
  ...
  wire [5:0]      _out_xbar_auto_out_1_a_bits_source;	// @[PeripheryBus.scala:50:30]
  wire [25:0]     _out_xbar_auto_out_1_a_bits_address;	// @[PeripheryBus.scala:50:30]
  wire [3:0]      _out_xbar_auto_out_1_a_bits_mask;	// @[PeripheryBus.scala:50:30]
  wire [31:0]     _out_xbar_auto_out_1_a_bits_data;	// @[PeripheryBus.scala:50:30]
  ...
  TLXbar_4 in_xbar (	// @[PeripheryBus.scala:49:29]
    ...
    .auto_in_1_a_bits_data    (_T_1 ? 32'h80000000 : 32'h1),	// @[CustomBootPin.scala:47:24, :51:23, Edges.scala:480:15]
