...
module Queue_32(
  ...
  ram_combMem_20 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({37'hF, io_enq_bits_address, io_enq_bits_source, 3'h6, io_enq_bits_param, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[78:47];	// @[Decoupled.scala:273:95]
