...
module SinkC(
  ...
  output [31:0] io_bs_dat_data,
  output        io_rel_pop_ready,
  output [31:0] io_rel_beat_data,
  ...
  wire [31:0] _c_io_deq_bits_data;	// @[Decoupled.scala:375:21]
  ...
  wire [3:0]  beats1 = _c_io_deq_bits_opcode[0] ? ~(_beats1_decode_T_1[5:2]) : 4'h0;	// @[Decoupled.scala:375:21, Edges.scala:102:36, :221:14, :229:27, package.scala:235:{46,71,76}]
  reg  [3:0]  counter;	// @[Edges.scala:229:27]
  wire [3:0]  counter1 = counter - 4'h1;	// @[Edges.scala:229:27, :230:28]
  wire        last = counter == 4'h1 | beats1 == 4'h0;	// @[Edges.scala:221:14, :229:27, :232:{25,33,43}]
  wire [3:0]  beat = beats1 & ~counter1;	// @[Edges.scala:221:14, :230:28, :234:{25,27}]
  ...
  reg  [31:0] io_bs_dat_data_r;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]  bs_adr_bits_beat_r;	// @[Reg.scala:19:16]
  ...
  wire [5:0]  _io_rel_pop_ready_T = {4'h0, _putbuffer_io_valid} >> io_rel_pop_bits_index;	// @[Edges.scala:229:27, SinkC.scala:115:27, :160:43]
  ...
  always @(posedge clock) begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      bs_adr_bits_beat_r <= beat + {3'h0, _io_bs_adr_q_io_enq_ready};	// @[Decoupled.scala:375:21, Edges.scala:234:25, Reg.scala:19:16, SinkC.scala:103:59]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        resp_r = _RANDOM_0[4];	// @[Edges.scala:229:27, Reg.scala:19:16]
        io_set_r = _RANDOM_0[14:5];	// @[Edges.scala:229:27, Reg.scala:19:16]
        io_bs_dat_data_r = {_RANDOM_0[31:15], _RANDOM_1[14:0]};	// @[Edges.scala:229:27, Reg.scala:19:16]
        bs_adr_bits_beat_r = _RANDOM_1[18:15];	// @[Reg.scala:19:16]
        lists = _RANDOM_1[20:19];	// @[Reg.scala:19:16, SinkC.scala:116:24]
        put_r = _RANDOM_1[22:21];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_37 c (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_38 io_bs_adr_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_req_bits_put = {4'h0, put};	// @[Edges.scala:229:27, SinkC.scala:140:18, :151:24]
