...
module TLInterconnectCoupler_17(
  ...
  wire [2:0]  _tl2axi4_auto_out_aw_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [2:0]  _tl2axi4_auto_out_aw_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  wire        _tl2axi4_auto_out_w_valid;	// @[ToAXI4.scala:286:29]
  wire [31:0] _tl2axi4_auto_out_w_bits_data;	// @[ToAXI4.scala:286:29]
  wire [3:0]  _tl2axi4_auto_out_w_bits_strb;	// @[ToAXI4.scala:286:29]
  ...
  wire [2:0]  _tl2axi4_auto_out_ar_bits_id;	// @[ToAXI4.scala:286:29]
  ...
  wire [2:0]  _tl2axi4_auto_out_ar_bits_echo_tl_state_source;	// @[ToAXI4.scala:286:29]
  ...
  wire [2:0]  _axi4index_auto_in_b_bits_id;	// @[IdIndexer.scala:94:31]
  ...
  wire [2:0]  _axi4index_auto_in_b_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_ar_ready;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_in_r_valid;	// @[IdIndexer.scala:94:31]
  wire [2:0]  _axi4index_auto_in_r_bits_id;	// @[IdIndexer.scala:94:31]
  wire [31:0] _axi4index_auto_in_r_bits_data;	// @[IdIndexer.scala:94:31]
  ...
  wire [2:0]  _axi4index_auto_in_r_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [2:0]  _axi4index_auto_out_aw_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  wire        _axi4index_auto_out_w_valid;	// @[IdIndexer.scala:94:31]
  wire [31:0] _axi4index_auto_out_w_bits_data;	// @[IdIndexer.scala:94:31]
  wire [3:0]  _axi4index_auto_out_w_bits_strb;	// @[IdIndexer.scala:94:31]
  ...
  wire [2:0]  _axi4index_auto_out_ar_bits_echo_tl_state_source;	// @[IdIndexer.scala:94:31]
  ...
  wire [2:0]  _axi4yank_auto_in_b_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
  ...
  wire [31:0] _axi4yank_auto_in_r_bits_data;	// @[UserYanker.scala:108:30]
  ...
  wire [2:0]  _axi4yank_auto_in_r_bits_echo_tl_state_source;	// @[UserYanker.scala:108:30]
