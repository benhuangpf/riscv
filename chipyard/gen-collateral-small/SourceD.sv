...
module SourceD(
  ...
  input         io_req_bits_bad,
                io_d_ready,
                io_pb_pop_ready,
  input  [31:0] io_pb_beat_data,
  input  [3:0]  io_pb_beat_mask,
  input         io_pb_beat_corrupt,
                io_rel_pop_ready,
  input  [31:0] io_rel_beat_data,
  input         io_rel_beat_corrupt,
                io_bs_radr_ready,
  input  [31:0] io_bs_rdat_data,
  ...
  reg  [4:0]      s1_req_reg_source;	// @[Reg.scala:19:16]
  ...
  wire            s1_need_r = ~s1_bypass & s1_req_prio_0 & s1_req_opcode != 3'h5 & ~s1_grant & ((|s1_req_opcode) | s1_req_size < 3'h2);	// @[SourceD.scala:88:19, :91:22, :92:78, :93:76, :94:{66,78,88}, :95:{34,50,65}, :282:84]
  wire            _io_bs_radr_valid_output = _s1_valid_T & s1_need_r & ~s1_block_r;	// @[SourceD.scala:85:27, :90:40, :94:88, :96:{56,59}]
  wire [3:0]      s1_beat = (busy ? s1_req_reg_offset[5:2] : io_req_bits_offset[5:2]) | s1_counter;	// @[Reg.scala:19:16, SourceD.scala:84:21, :86:27, :88:19, :102:56]
  ...
  reg  [3:0]      s2_beat;	// @[Reg.scala:19:16]
  ...
  reg  [31:0]     s2_pdata_r_data;	// @[Reg.scala:19:16]
  reg  [3:0]      s2_pdata_r_mask;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]      s3_beat;	// @[Reg.scala:19:16]
  ...
  reg  [31:0]     s3_pdata_data;	// @[Reg.scala:19:16]
  reg  [3:0]      s3_pdata_mask;	// @[Reg.scala:19:16]
  ...
  wire [7:0][2:0] _GEN = {{3'h4}, {{2'h2, s3_req_param != 3'h2}}, {3'h2}, {3'h1}, {3'h1}, {3'h1}, {3'h0}, {3'h0}};	// @[Reg.scala:19:16, SourceD.scala:195:31, :214:{18,32}, :222:24, :280:84, :281:84, :282:84]
  ...
  reg  [3:0]      s4_beat;	// @[Reg.scala:19:16]
  ...
  reg  [31:0]     s4_pdata_data;	// @[Reg.scala:19:16]
  reg  [3:0]      s4_pdata_mask;	// @[Reg.scala:19:16]
  reg             s4_pdata_corrupt;	// @[Reg.scala:19:16]
  reg  [31:0]     s4_rdata;	// @[Reg.scala:19:16]
  ...
  reg  [3:0]      s5_beat;	// @[Reg.scala:19:16]
  reg  [31:0]     s5_dat;	// @[Reg.scala:19:16]
  reg  [9:0]      s6_req_set;	// @[Reg.scala:19:16]
  reg  [2:0]      s6_req_way;	// @[Reg.scala:19:16]
  reg  [3:0]      s6_beat;	// @[Reg.scala:19:16]
  reg  [31:0]     s6_dat;	// @[Reg.scala:19:16]
  reg  [31:0]     s7_dat;	// @[Reg.scala:19:16]
  reg             s3_bypass_data_REG;	// @[SourceD.scala:337:19]
  reg  [31:0]     s3_bypass_data_REG_1;	// @[SourceD.scala:337:66]
  ...
  wire            s1_last = s1_counter == (s1_single ? 4'h0 : ~(_s1_beats1_T_1[5:2]));	// @[SourceD.scala:86:27, :98:22, :101:22, :103:28, package.scala:235:{46,71,76}]
  ...
  wire [3:0]      pre_s3_beat = s3_latch ? s2_beat : s3_beat;	// @[Reg.scala:19:16, SourceD.scala:177:18, :319:24]
  always @(posedge clock) begin
    if (reset) begin
      busy <= 1'h0;	// @[SourceD.scala:84:21]
      s1_block_r <= 1'h0;	// @[SourceD.scala:84:21, :85:27]
      s1_counter <= 4'h0;	// @[SourceD.scala:86:27]
      ...
      if (s2_latch) begin	// @[SourceD.scala:129:18]
        if (s1_last)	// @[SourceD.scala:103:28]
          ...
          s1_counter <= s1_counter + 4'h1;	// @[SourceD.scala:86:27, :130:30]
    ...
    if (s2_latch) begin	// @[SourceD.scala:129:18]
      ...
      s2_need_d <= ~(s1_req_prio_0 ? ~(s1_req_opcode[2]) : s1_req_opcode[0]) | s1_counter == 4'h0;	// @[Reg.scala:19:16, SourceD.scala:86:27, :88:19, :97:{23,40,54,72}, :104:29, :156:{29,41}]
    end
    if (s2_valid_pb) begin	// @[SourceD.scala:148:28]
      if (s2_req_prio_0) begin	// @[Reg.scala:19:16]
        ...
        s2_pdata_r_mask <= 4'hF;	// @[Reg.scala:19:16, SourceD.scala:161:64]
    ...
    if (s3_latch) begin	// @[SourceD.scala:177:18]
      ...
      if (s2_valid_pb) begin	// @[SourceD.scala:148:28]
        if (s2_req_prio_0) begin	// @[Reg.scala:19:16]
          ...
          s3_pdata_mask <= 4'hF;	// @[Reg.scala:19:16, SourceD.scala:161:64]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_counter = _RANDOM_0[5:2];	// @[SourceD.scala:84:21, :86:27]
        s1_req_reg_prio_0 = _RANDOM_0[6];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_prio_2 = _RANDOM_0[8];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_opcode = _RANDOM_0[12:10];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_param = _RANDOM_0[15:13];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_size = _RANDOM_0[18:16];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        s1_req_reg_source = _RANDOM_0[23:19];	// @[Reg.scala:19:16, SourceD.scala:84:21]
        ...
        s1_req_reg_sink = _RANDOM_1[28:26];	// @[Reg.scala:19:16]
        s1_req_reg_way = _RANDOM_1[31:29];	// @[Reg.scala:19:16]
        s1_req_reg_bad = _RANDOM_2[0];	// @[Reg.scala:19:16]
        s1_latch_bypass = _RANDOM_2[1];	// @[Reg.scala:19:16, SourceD.scala:90:32]
        s1_bypass_r = _RANDOM_2[2];	// @[Reg.scala:19:16]
        queue_io_enq_valid_REG = _RANDOM_2[3];	// @[Reg.scala:19:16, SourceD.scala:121:40]
        queue_io_enq_valid_REG_1 = _RANDOM_2[4];	// @[Reg.scala:19:16, SourceD.scala:121:32]
        s2_full = _RANDOM_2[5];	// @[Reg.scala:19:16, SourceD.scala:147:24]
        s2_valid_pb = _RANDOM_2[6];	// @[Reg.scala:19:16, SourceD.scala:148:28]
        s2_beat = _RANDOM_2[10:7];	// @[Reg.scala:19:16]
        s2_bypass = _RANDOM_2[11];	// @[Reg.scala:19:16]
        s2_req_prio_0 = _RANDOM_2[12];	// @[Reg.scala:19:16]
        s2_req_prio_2 = _RANDOM_2[14];	// @[Reg.scala:19:16]
        s2_req_opcode = _RANDOM_2[18:16];	// @[Reg.scala:19:16]
        s2_req_param = _RANDOM_2[21:19];	// @[Reg.scala:19:16]
        s2_req_size = _RANDOM_2[24:22];	// @[Reg.scala:19:16]
        s2_req_source = _RANDOM_2[29:25];	// @[Reg.scala:19:16]
        s2_req_put = _RANDOM_3[21:16];	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_3[31:22];	// @[Reg.scala:19:16]
        s2_req_sink = _RANDOM_4[2:0];	// @[Reg.scala:19:16]
        s2_req_way = _RANDOM_4[5:3];	// @[Reg.scala:19:16]
        s2_req_bad = _RANDOM_4[6];	// @[Reg.scala:19:16]
        s2_last = _RANDOM_4[7];	// @[Reg.scala:19:16]
        s2_need_r = _RANDOM_4[8];	// @[Reg.scala:19:16]
        s2_need_pb = _RANDOM_4[9];	// @[Reg.scala:19:16]
        s2_retires = _RANDOM_4[10];	// @[Reg.scala:19:16]
        s2_need_d = _RANDOM_4[11];	// @[Reg.scala:19:16]
        s2_pdata_r_data = {_RANDOM_4[31:12], _RANDOM_5[11:0]};	// @[Reg.scala:19:16]
        s2_pdata_r_mask = _RANDOM_5[15:12];	// @[Reg.scala:19:16]
        s2_pdata_r_corrupt = _RANDOM_5[16];	// @[Reg.scala:19:16]
        s3_full = _RANDOM_5[17];	// @[Reg.scala:19:16, SourceD.scala:190:24]
        s3_valid_d = _RANDOM_5[18];	// @[Reg.scala:19:16, SourceD.scala:191:27]
        s3_beat = _RANDOM_5[22:19];	// @[Reg.scala:19:16]
        s3_bypass = _RANDOM_5[23];	// @[Reg.scala:19:16]
        s3_req_prio_0 = _RANDOM_5[24];	// @[Reg.scala:19:16]
        s3_req_prio_2 = _RANDOM_5[26];	// @[Reg.scala:19:16]
        s3_req_opcode = _RANDOM_5[30:28];	// @[Reg.scala:19:16]
        s3_req_param = {_RANDOM_5[31], _RANDOM_6[1:0]};	// @[Reg.scala:19:16]
        s3_req_size = _RANDOM_6[4:2];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_6[9:5];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_7[11:2];	// @[Reg.scala:19:16]
        s3_req_sink = _RANDOM_7[14:12];	// @[Reg.scala:19:16]
        s3_req_way = _RANDOM_7[17:15];	// @[Reg.scala:19:16]
        s3_req_bad = _RANDOM_7[18];	// @[Reg.scala:19:16]
        s3_pdata_data = {_RANDOM_7[31:20], _RANDOM_8[19:0]};	// @[Reg.scala:19:16]
        s3_pdata_mask = _RANDOM_8[23:20];	// @[Reg.scala:19:16]
        s3_pdata_corrupt = _RANDOM_8[24];	// @[Reg.scala:19:16]
        s3_need_bs = _RANDOM_8[25];	// @[Reg.scala:19:16]
        s3_retires = _RANDOM_8[26];	// @[Reg.scala:19:16]
        s3_need_r = _RANDOM_8[27];	// @[Reg.scala:19:16]
        s4_full = _RANDOM_8[28];	// @[Reg.scala:19:16, SourceD.scala:248:24]
        s4_beat = {_RANDOM_8[31:29], _RANDOM_9[0]};	// @[Reg.scala:19:16]
        s4_need_bs = _RANDOM_9[2];	// @[Reg.scala:19:16]
        s4_need_pb = _RANDOM_9[3];	// @[Reg.scala:19:16]
        s4_req_prio_2 = _RANDOM_9[6];	// @[Reg.scala:19:16]
        s4_req_param = _RANDOM_9[13:11];	// @[Reg.scala:19:16]
        s4_req_set = _RANDOM_10[23:14];	// @[Reg.scala:19:16]
        s4_req_way = _RANDOM_10[29:27];	// @[Reg.scala:19:16]
        s4_adjusted_opcode = {_RANDOM_10[31], _RANDOM_11[1:0]};	// @[Reg.scala:19:16]
        s4_pdata_data = {_RANDOM_11[31:2], _RANDOM_12[1:0]};	// @[Reg.scala:19:16]
        s4_pdata_mask = _RANDOM_12[5:2];	// @[Reg.scala:19:16]
        s4_pdata_corrupt = _RANDOM_12[6];	// @[Reg.scala:19:16]
        s4_rdata = {_RANDOM_12[31:7], _RANDOM_13[6:0]};	// @[Reg.scala:19:16]
        s5_req_set = _RANDOM_14[26:17];	// @[Reg.scala:19:16]
        s5_req_way = {_RANDOM_14[31:30], _RANDOM_15[0]};	// @[Reg.scala:19:16]
        s5_beat = _RANDOM_15[5:2];	// @[Reg.scala:19:16]
        s5_dat = {_RANDOM_15[31:6], _RANDOM_16[5:0]};	// @[Reg.scala:19:16]
        s6_req_set = _RANDOM_17[25:16];	// @[Reg.scala:19:16]
        s6_req_way = _RANDOM_17[31:29];	// @[Reg.scala:19:16]
        s6_beat = _RANDOM_18[4:1];	// @[Reg.scala:19:16]
        s6_dat = {_RANDOM_18[31:5], _RANDOM_19[4:0]};	// @[Reg.scala:19:16]
        s7_dat = {_RANDOM_19[31:5], _RANDOM_20[4:0]};	// @[Reg.scala:19:16]
        s3_bypass_data_REG = _RANDOM_20[5];	// @[Reg.scala:19:16, SourceD.scala:337:19]
        s3_bypass_data_REG_1 = {_RANDOM_20[31:6], _RANDOM_21[5:0]};	// @[Reg.scala:19:16, SourceD.scala:337:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_34 queue (	// @[SourceD.scala:120:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_d_bits_param = s3_req_prio_0 & (s3_req_opcode == 3'h6 | (&s3_req_opcode)) ? {1'h0, s3_req_param == 3'h0} : 2'h0;	// @[Misc.scala:201:34, Reg.scala:19:16, SourceD.scala:84:21, :93:33, :202:{30,47,64}, :223:{24,40,54,68}, :280:84]
