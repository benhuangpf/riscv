...
module DCache(
  ...
  wire             s2_victim_dirty = &((|s2_hit_state_state) ? s2_hit_state_state : s2_meta_corrected_r[19:18]);	// @[DCache.scala:338:99, :411:28, Metadata.scala:50:45, Misc.scala:37:9, :55:20, Reg.scala:19:16]
  ...
  assign metaArb_io_in_2_valid = s2_valid_hit_pre_data_ecc_and_waw & s2_hit_state_state != _GEN_2[_T_36];	// @[Cat.scala:33:92, DCache.scala:395:89, :423:62, Metadata.scala:46:46, Misc.scala:34:36, :48:20, Reg.scala:19:16]
  ...
  wire             d_last = counter == 10'h1 | (auto_out_d_bits_opcode[0] ? ~(_beats1_decode_T_1[11:2]) : 10'h0) == 10'h0;	// @[DCache.scala:267:18, Edges.scala:106:36, :221:14, :229:27, :232:{25,33,43}, package.scala:235:{46,71,76}]
  ...
  wire [1:0]       _GEN_5 = {s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16]};	// @[Parameters.scala:137:45, Reg.scala:19:16]
  wire [1:0]       _GEN_6 = {s1_tlb_req_vaddr[26], ~(s1_tlb_req_vaddr[20])};	// @[Parameters.scala:137:{31,45}, Reg.scala:19:16]
  wire             tlb_prot_al = tlb_legal_address & (_GEN_5 == 2'h0 | _GEN_6 == 2'h0 | s1_tlb_req_vaddr[26]);	// @[Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, TLB.scala:410:67, :413:19]
  wire             tlb_prot_aa = tlb_legal_address & (_GEN_5 == 2'h0 | _GEN_6 == 2'h0 | s1_tlb_req_vaddr[26]);	// @[Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, TLB.scala:410:67, :413:19]
  wire [3:0]       _GEN_7 = s1_tlb_req_vaddr[3:0] & (4'h1 << s1_tlb_req_size) - 4'h1;	// @[OneHot.scala:57:35, Reg.scala:19:16, TLB.scala:539:{39,69}, package.scala:16:47]
  ...
  wire             _GEN_8 = (|_GEN_7) & tlb_legal_address & ({s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[25], s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16], s1_tlb_req_vaddr[13]} == 5'h0 | {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[26:25], ~(s1_tlb_req_vaddr[20]), s1_tlb_req_vaddr[13]} == 5'h0 | {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[26:25] ^ 2'h1, s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16]} == 5'h0 | {s1_tlb_req_vaddr[31], ~(s1_tlb_req_vaddr[26])} == 2'h0) | tlb__cmd_lrsc_T_2;	// @[Parameters.scala:137:{31,45,65}, :616:89, Reg.scala:19:16, TLB.scala:410:67, :539:{39,77}, :571:{8,37}, package.scala:16:47, :73:59]
  wire             _GEN_9 = tlb_cmd_put_partial & ~(tlb_legal_address & (_GEN_5 == 2'h0 | _GEN_6 == 2'h0 | s1_tlb_req_vaddr[26]));	// @[Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, TLB.scala:410:67, :413:19, :562:41, :578:{8,26}]
  ...
  wire             _GEN_10 = _io_cpu_perf_acquire_T & s2_uncached;	// @[DCache.scala:213:33, :401:39, :608:26, :609:24, :611:18, Decoupled.scala:51:35]
  always @(posedge clock) begin
    if (reset) begin
      ...
      uncachedInFlight_0 <= (~_io_errors_bus_valid_T | ~d_last) & (_GEN_10 | uncachedInFlight_0);	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :651:26, :652:26, :663:28, :665:13, Decoupled.scala:51:35, Edges.scala:232:33]
      ...
      if (_io_errors_bus_valid_T) begin	// @[Decoupled.scala:51:35]
        if (|counter)	// @[Edges.scala:229:27, :231:25]
          counter <= counter - 10'h1;	// @[Edges.scala:229:27, :230:28]
    ...
    if (_GEN_10) begin	// @[DCache.scala:213:33, :608:26, :609:24, :611:18]
    ...
    if (s1_valid_not_nacked) begin	// @[DCache.scala:164:38]
      ...
      s2_tlb_xcpt_ae_ld <= tlb_cmd_read & (_GEN_8 | ~(tlb_legal_address & ~tlb_deny_access_to_debug & _tlb_pmp_io_r));	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:403:19, :410:67, :418:50, :419:{44,66}, :571:37, :575:{24,44,46}]
      s2_tlb_xcpt_ae_st <= (tlb_cmd_write | s1_tlb_req_cmd == 5'h5 | s1_tlb_req_cmd == 5'h17) & (_GEN_8 | ~(tlb_legal_address & (_GEN_5 == 2'h0 | _GEN_6 == 2'h0 | s1_tlb_req_vaddr[26]) & ~tlb_deny_access_to_debug & _tlb_pmp_io_w)) | _GEN_9 | tlb__cmd_amo_logical_T_6 & ~tlb_prot_al | tlb__cmd_amo_arithmetic_T_8 & ~tlb_prot_aa;	// @[Consts.scala:86:76, DCache.scala:319:24, Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, TLB.scala:403:19, :410:67, :413:19, :418:50, :419:44, :420:70, :566:35, :571:37, :577:{8,35,37}, :578:8, :579:{8,26,53}, :580:{8,29}, package.scala:16:47, :73:59]
      s2_tlb_xcpt_ma_ld <= (|_GEN_7) & tlb_cmd_read;	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:539:{39,77}, :634:31]
      s2_tlb_xcpt_ma_st <= (|_GEN_7) & tlb_cmd_write;	// @[Consts.scala:86:76, DCache.scala:319:24, TLB.scala:539:{39,77}, :635:31]
      s2_pma_must_alloc <= _GEN_9 | tlb__cmd_amo_logical_T_6 & ~tlb_prot_aa | tlb__cmd_amo_arithmetic_T_8 & ~tlb_prot_al | tlb__cmd_lrsc_T_2;	// @[DCache.scala:320:19, TLB.scala:413:19, :578:8, :579:26, :580:29, :583:8, :584:{8,46}, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = _RANDOM_69[11:2];	// @[DCache.scala:508:19, Edges.scala:229:27]
  ...
  assign auto_out_a_bits_size = _GEN_3 ? {2'h0, s2_req_size} : 4'h0;	// @[DCache.scala:316:19, :585:23, Edges.scala:457:15]
