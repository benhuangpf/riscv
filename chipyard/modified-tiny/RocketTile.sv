...
module RocketTile(
  ...
  wire [31:0] _core_io_imem_req_bits_pc;	// @[RocketTile.scala:127:20]
  ...
  wire [31:0] _core_io_dmem_req_bits_addr;	// @[RocketTile.scala:127:20]
  ...
  wire [31:0] _core_io_dmem_s1_data_data;	// @[RocketTile.scala:127:20]
  ...
  wire [31:0] _core_io_ptw_customCSRs_csrs_0_value;	// @[RocketTile.scala:127:20]
  ...
  wire [11:0] _fragmenter_1_auto_out_a_bits_source;	// @[Fragmenter.scala:335:34]
  wire [31:0] _fragmenter_1_auto_out_a_bits_address;	// @[Fragmenter.scala:335:34]
  wire [3:0]  _fragmenter_1_auto_out_a_bits_mask;	// @[Fragmenter.scala:335:34]
  wire [31:0] _fragmenter_1_auto_out_a_bits_data;	// @[Fragmenter.scala:335:34]
  ...
  wire [11:0] _dtim_adapter_auto_in_d_bits_source;	// @[RocketTile.scala:60:15]
  wire [31:0] _dtim_adapter_auto_in_d_bits_data;	// @[RocketTile.scala:60:15]
  wire        _dtim_adapter_io_dmem_req_valid;	// @[RocketTile.scala:60:15]
  wire [31:0] _dtim_adapter_io_dmem_req_bits_addr;	// @[RocketTile.scala:60:15]
  ...
  wire [31:0] _dtim_adapter_io_dmem_s1_data_data;	// @[RocketTile.scala:60:15]
  wire [3:0]  _dtim_adapter_io_dmem_s1_data_mask;	// @[RocketTile.scala:60:15]
  ...
  wire [31:0] _dcache_io_cpu_resp_bits_addr;	// @[HellaCache.scala:267:43]
  ...
  wire [3:0]  _dcache_io_cpu_resp_bits_mask;	// @[HellaCache.scala:267:43]
  ...
  wire [31:0] _dcache_io_cpu_resp_bits_store_data;	// @[HellaCache.scala:267:43]
  ...
  DCache dcache (	// @[HellaCache.scala:267:43]
    ...
    .auto_out_a_ready                  (1'b1),	// @[BaseTile.scala:223:42]
    // .auto_out_d_valid                  (_tlMasterXbar_auto_in_0_d_valid),
    .auto_out_d_valid                  (1'b0),	// @[BaseTile.scala:223:42]
    ...
    .io_cpu_req_valid                  (_core_io_dmem_req_valid),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_addr              (_core_io_dmem_req_bits_addr),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_tag               (_core_io_dmem_req_bits_tag),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_cmd               (_core_io_dmem_req_bits_cmd),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_size              (_core_io_dmem_req_bits_size),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_signed            (_core_io_dmem_req_bits_signed),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_dprv              (_core_io_dmem_req_bits_dprv),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_dv                (_core_io_dmem_req_bits_dv),	// @[HellaCache.scala:278:25]
    .io_cpu_req_bits_no_xcpt           (1'b1),	// @[HellaCache.scala:278:25]
    .io_cpu_s1_kill                    (_core_io_dmem_s1_kill),	// @[HellaCache.scala:278:25]
    .io_cpu_s1_data_data               (_core_io_dmem_s1_data_data),	// @[HellaCache.scala:278:25]
    .io_cpu_s1_data_mask               (4'h0),	// @[HellaCache.scala:278:25]
  ...
  // );
  // TLFragmenter_8 fragmenter_1 (	// @[Fragmenter.scala:335:34]
  //   .clock                   (clock),
  //   .reset                   (reset),
  ...
  //   .clock                                     (clock),
  //   .io_requestor_0_req_valid                  (_core_io_dmem_req_valid),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_addr              (_core_io_dmem_req_bits_addr),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_tag               (_core_io_dmem_req_bits_tag),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_cmd               (_core_io_dmem_req_bits_cmd),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_size              (_core_io_dmem_req_bits_size),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_signed            (_core_io_dmem_req_bits_signed),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_dprv              (_core_io_dmem_req_bits_dprv),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_req_bits_dv                (_core_io_dmem_req_bits_dv),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_s1_kill                    (_core_io_dmem_s1_kill),	// @[RocketTile.scala:127:20]
  //   .io_requestor_0_s1_data_data               (_core_io_dmem_s1_data_data),	// @[RocketTile.scala:127:20]
  //   // .io_requestor_1_req_valid                  (_dtim_adapter_io_dmem_req_valid),	// @[RocketTile.scala:60:15]
  //   .io_requestor_1_req_valid                  (1'b0),
  //   .io_requestor_1_req_bits_addr              (_dtim_adapter_io_dmem_req_bits_addr),	// @[RocketTile.scala:60:15]
  //   .io_requestor_1_req_bits_cmd               (_dtim_adapter_io_dmem_req_bits_cmd),	// @[RocketTile.scala:60:15]
  //   .io_requestor_1_req_bits_size              (_dtim_adapter_io_dmem_req_bits_size),	// @[RocketTile.scala:60:15]
  //   // .io_requestor_1_s1_kill                    (_dtim_adapter_io_dmem_s1_kill),	// @[RocketTile.scala:60:15]
  //   .io_requestor_1_s1_kill                    (1'b0),
  //   .io_requestor_1_s1_data_data               (_dtim_adapter_io_dmem_s1_data_data),	// @[RocketTile.scala:60:15]
  //   .io_requestor_1_s1_data_mask               (_dtim_adapter_io_dmem_s1_data_mask),	// @[RocketTile.scala:60:15]
  ...
  Rocket core (	// @[RocketTile.scala:127:20]
    ...
    .io_interrupts_debug                (1'b0),	// @[BaseTile.scala:225:37]
    .io_interrupts_mtip                 (1'b0),	// @[BaseTile.scala:225:37]
    .io_interrupts_msip                 (1'b0),	// @[BaseTile.scala:225:37]
    .io_interrupts_meip                 (1'b0),	// @[BaseTile.scala:225:37]
    ...
    .io_dmem_req_ready                  (_dcache_io_cpu_req_ready),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_nack                    (_dcache_io_cpu_s2_nack),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_valid                 (_dcache_io_cpu_resp_valid),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_bits_tag              (_dcache_io_cpu_resp_bits_tag),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_bits_data             (_dcache_io_cpu_resp_bits_data),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_bits_replay           (_dcache_io_cpu_resp_bits_replay),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_bits_has_data         (_dcache_io_cpu_resp_bits_has_data),	// @[HellaCache.scala:278:25]
    .io_dmem_resp_bits_data_word_bypass (_dcache_io_cpu_resp_bits_data_word_bypass),	// @[HellaCache.scala:278:25]
    .io_dmem_replay_next                (_dcache_io_cpu_replay_next),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_ma_ld              (_dcache_io_cpu_s2_xcpt_ma_ld),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_ma_st              (_dcache_io_cpu_s2_xcpt_ma_st),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_pf_ld              (_dcache_io_cpu_s2_xcpt_pf_ld),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_pf_st              (_dcache_io_cpu_s2_xcpt_pf_st),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_gf_ld              (_dcache_io_cpu_s2_xcpt_gf_ld),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_gf_st              (_dcache_io_cpu_s2_xcpt_gf_st),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_ae_ld              (_dcache_io_cpu_s2_xcpt_ae_ld),	// @[HellaCache.scala:278:25]
    .io_dmem_s2_xcpt_ae_st              (_dcache_io_cpu_s2_xcpt_ae_st),	// @[HellaCache.scala:278:25]
    .io_dmem_ordered                    (_dcache_io_cpu_ordered),	// @[HellaCache.scala:278:25]
    .io_dmem_perf_grant                 (_dcache_io_cpu_perf_grant),	// @[HellaCache.scala:278:25]
