...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/ben/RV32ISC/test_run_dir/MemData_should_pass/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_bundleMemDataControl_ctrlLoad = u; break;
      case 2 : dut->io_bundleMemDataControl_ctrlStore = u; break;
      case 3 : dut->io_bundleMemDataControl_ctrlSigned = u; break;
      case 4 : dut->io_bundleMemDataControl_ctrlLSType = u; break;
      case 5 : dut->io_resultALU = u; break;
      case 6 : dut->io_dataStore = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_bundleMemDataControl_ctrlLoad; break;
      case 2 : value = dut->io_bundleMemDataControl_ctrlStore; break;
      case 3 : value = dut->io_bundleMemDataControl_ctrlSigned; break;
      case 4 : value = dut->io_bundleMemDataControl_ctrlLSType; break;
      case 5 : value = dut->io_resultALU; break;
      case 6 : value = dut->io_dataStore; break;
      case 7 : value = dut->io_result; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/ben/RV32ISC/test_run_dir/MemData_should_pass/MemData.";
