...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 6 : dut->io_a = u; break;
      case 7 : dut->io_b = u; break;
      case 8 : dut->io_cin = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 6 : value = dut->io_a; break;
      case 7 : value = dut->io_b; break;
      case 8 : value = dut->io_cin; break;
      case 9 : value = dut->io_sum; break;
      case 10 : value = dut->io_cout; break;
