...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/ben/mytest_a/test_run_dir/ALU_should_wave/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_bundleAluControl_ctrlALUSrc = u; break;
      case 2 : dut->io_bundleAluControl_ctrlJAL = u; break;
      case 3 : dut->io_bundleAluControl_ctrlOP = u; break;
      case 4 : dut->io_bundleAluControl_ctrlSigned = u; break;
      case 5 : dut->io_bundleAluControl_ctrlBranch = u; break;
      case 6 : dut->io_dataRead1 = u; break;
      case 7 : dut->io_dataRead2 = u; break;
      case 8 : dut->io_imm = u; break;
      case 9 : dut->io_pc = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_bundleAluControl_ctrlALUSrc; break;
      case 2 : value = dut->io_bundleAluControl_ctrlJAL; break;
      case 3 : value = dut->io_bundleAluControl_ctrlOP; break;
      case 4 : value = dut->io_bundleAluControl_ctrlSigned; break;
      case 5 : value = dut->io_bundleAluControl_ctrlBranch; break;
      case 6 : value = dut->io_dataRead1; break;
      case 7 : value = dut->io_dataRead2; break;
      case 8 : value = dut->io_imm; break;
      case 9 : value = dut->io_pc; break;
      case 10 : value = dut->io_resultBranch; break;
      case 11 : value = dut->io_resultAlu; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/ben/mytest_a/test_run_dir/ALU_should_wave/Alu.vcd)";
