...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/ben/combine/test_run_dir/ALU_should_pass/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/ben/combine/test_run_dir/ALU_should_pass/Alu.vcd)";
