...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/ben/RV32ISC/test_run_dir/PCReg_should_pass/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_ctrlJump = u; break;
      case 2 : dut->io_ctrlBranch = u; break;
      case 3 : dut->io_resultBranch = u; break;
      case 4 : dut->io_addrTarget = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_ctrlJump; break;
      case 2 : value = dut->io_ctrlBranch; break;
      case 3 : value = dut->io_resultBranch; break;
      case 4 : value = dut->io_addrTarget; break;
      case 5 : value = dut->io_addrOut; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/ben/RV32ISC/test_run_dir/PCReg_should_pass/PCReg.";
