...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/ben/RV32ISC/test_run_dir/Decoder_should_pass/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_inst; break;
      case 2 : value = dut->io_bundleCtrl_ctrlJump; break;
      case 3 : value = dut->io_bundleCtrl_ctrlBranch; break;
      case 4 : value = dut->io_bundleCtrl_ctrlRegWrite; break;
      case 5 : value = dut->io_bundleCtrl_ctrlLoad; break;
      case 6 : value = dut->io_bundleCtrl_ctrlStore; break;
      case 7 : value = dut->io_bundleCtrl_ctrlALUSrc; break;
      case 8 : value = dut->io_bundleCtrl_ctrlJAL; break;
      case 9 : value = dut->io_bundleCtrl_ctrlOP; break;
      case 10 : value = dut->io_bundleCtrl_ctrlSigned; break;
      case 11 : value = dut->io_bundleCtrl_ctrlLSType; break;
      case 12 : value = dut->io_bundleReg_rs1; break;
      case 13 : value = dut->io_bundleReg_rs2; break;
      case 14 : value = dut->io_bundleReg_rd; break;
      case 15 : value = dut->io_imm; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/ben/RV32ISC/test_run_dir/Decoder_should_pass/Decoder.";
