...
#endif
#if VM_COVERAGE
  VerilatedCov::write("/home/ben/RV32ISC/test_run_dir/Registers_should_pass/coverage.dat");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_ctrlRegWrite = u; break;
      case 2 : dut->io_ctrlJump = u; break;
      case 3 : dut->io_pc = u; break;
      case 4 : dut->io_dataWrite = u; break;
      case 5 : dut->io_bundleReg_rs1 = u; break;
      case 6 : dut->io_bundleReg_rs2 = u; break;
      case 7 : dut->io_bundleReg_rd = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_ctrlRegWrite; break;
      case 2 : value = dut->io_ctrlJump; break;
      case 3 : value = dut->io_pc; break;
      case 4 : value = dut->io_dataWrite; break;
      case 5 : value = dut->io_bundleReg_rs1; break;
      case 6 : value = dut->io_bundleReg_rs2; break;
      case 7 : value = dut->io_bundleReg_rd; break;
      case 8 : value = dut->io_dataRead1; break;
      case 9 : value = dut->io_dataRead2; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = "/home/ben/RV32ISC/test_run_dir/Registers_should_pass/Registers.";
